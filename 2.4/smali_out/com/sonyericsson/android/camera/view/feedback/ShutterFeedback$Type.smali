...
.method static constructor <clinit>()V
    ...
    .line 85
    new-instance v9, Lcom/sonyericsson/android/camera/view/feedback/ShutterFeedback$Type;
    ...
    invoke-direct/range {v0 .. v8}, Lcom/sonyericsson/android/camera/view/feedback/ShutterFeedback$Type;-><init>(Ljava/lang/String;ILcom/sonyericsson/android/camera/device/CameraActionSound$Type;Lcom/sonyericsson/android/camera/device/CameraActionSound$Type;Lcom/sonyericsson/android/camera/view/ViewFinder$ViewUpdateEvent;Lcom/sonyericsson/android/camera/view/ViewFinder$ViewUpdateEvent;ZZ)V

    sput-object v9, Lcom/sonyericsson/android/camera/view/feedback/ShutterFeedback$Type;->ON_SHUTTER_DONE:Lcom/sonyericsson/android/camera/view/feedback/ShutterFeedback$Type;

    .line 93
    new-instance v0, Lcom/sonyericsson/android/camera/view/feedback/ShutterFeedback$Type;

    const-string v11, "ON_CAPTURE_REQUEST"

    sget-object v13, Lcom/sonyericsson/android/camera/device/CameraActionSound$Type;->SHUTTER_CLICK:Lcom/sonyericsson/android/camera/device/CameraActionSound$Type;
    ...
    invoke-direct/range {v10 .. v18}, Lcom/sonyericsson/android/camera/view/feedback/ShutterFeedback$Type;-><init>(Ljava/lang/String;ILcom/sonyericsson/android/camera/device/CameraActionSound$Type;Lcom/sonyericsson/android/camera/device/CameraActionSound$Type;Lcom/sonyericsson/android/camera/view/ViewFinder$ViewUpdateEvent;Lcom/sonyericsson/android/camera/view/ViewFinder$ViewUpdateEvent;ZZ)V
    ...
    invoke-direct/range {v1 .. v9}, Lcom/sonyericsson/android/camera/view/feedback/ShutterFeedback$Type;-><init>(Ljava/lang/String;ILcom/sonyericsson/android/camera/device/CameraActionSound$Type;Lcom/sonyericsson/android/camera/device/CameraActionSound$Type;Lcom/sonyericsson/android/camera/view/ViewFinder$ViewUpdateEvent;Lcom/sonyericsson/android/camera/view/ViewFinder$ViewUpdateEvent;ZZ)V
    ...
    const-string v11, "DIVIDE_SOUND_LONG"

    sget-object v13, Lcom/sonyericsson/android/camera/device/CameraActionSound$Type;->SHUTTER_CLICK_FIRST_HALF:Lcom/sonyericsson/android/camera/device/CameraActionSound$Type;

    sget-object v14, Lcom/sonyericsson/android/camera/device/CameraActionSound$Type;->SHUTTER_CLICK_SECOND_HALF:Lcom/sonyericsson/android/camera/device/CameraActionSound$Type;

    sget-object v15, Lcom/sonyericsson/android/camera/view/ViewFinder$ViewUpdateEvent;->EVENT_REQUEST_CAPTURE_FEEDBACK_PROGRESS_LONG:Lcom/sonyericsson/android/camera/view/ViewFinder$ViewUpdateEvent;
...
.method private constructor <init>(Ljava/lang/String;ILcom/sonyericsson/android/camera/device/CameraActionSound$Type;Lcom/sonyericsson/android/camera/device/CameraActionSound$Type;Lcom/sonyericsson/android/camera/view/ViewFinder$ViewUpdateEvent;Lcom/sonyericsson/android/camera/view/ViewFinder$ViewUpdateEvent;ZZ)V
    ...
    .line 144
    iput-boolean p8, p0, Lcom/sonyericsson/android/camera/view/feedback/ShutterFeedback$Type;->isLongExposure:Z
...
.method static synthetic access$500(Lcom/sonyericsson/android/camera/view/feedback/ShutterFeedback$Type;)Z
    .registers 1

    .line 84
    iget-boolean p0, p0, Lcom/sonyericsson/android/camera/view/feedback/ShutterFeedback$Type;->isLongExposure:Z
