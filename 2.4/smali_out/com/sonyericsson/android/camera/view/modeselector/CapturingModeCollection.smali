...
.method private saveCapturingModeSortedList(Ljava/util/List;)V
    ...
    :cond_4c
    :try_start_4c
    iget-object p1, p0, Lcom/sonyericsson/android/camera/view/modeselector/CapturingModeCollection;->mResolver:Landroid/content/ContentResolver;
    ...
    const-string v3, "Failed to save mode order. Message : "
...
.method private unregisterCapturingModes(Ljava/util/List;)V
    ...
    .line 337
    :try_start_34
    iget-object v2, p0, Lcom/sonyericsson/android/camera/view/modeselector/CapturingModeCollection;->mResolver:Landroid/content/ContentResolver;
    ...
    const-string v3, "Failed to unregister modes. Message : "
...
.method public getCapturingModeList([Lcom/sonyericsson/android/camera/view/modeselector/CapturingModeAttributes$InternalCaptureType;[Lcom/sonyericsson/android/camera/view/modeselector/CapturingModeAttributes$VisibilityType;)Ljava/util/List;
    ...
    .line 302
    invoke-static {p2}, Lcom/sonyericsson/android/camera/view/modeselector/CapturingModeCollection;->convert(Landroid/database/Cursor;)Lcom/sonyericsson/android/camera/view/modeselector/CapturingModeAttributes;
    ...
    const-string p2, "Fail to retrieve the capturing mode list from CameraCommonProvider."
