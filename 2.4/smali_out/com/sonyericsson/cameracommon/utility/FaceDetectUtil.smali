...
.method public static getFaceInformationList(Lcom/sonyericsson/android/camera/device/CameraParameters$FaceDetectionResult;Landroid/graphics/Rect;Ljava/lang/String;)Lcom/sonyericsson/cameracommon/focusview/FaceInformationList;
    ...
    .line 214
    :cond_43
    new-instance v0, Lcom/sonyericsson/cameracommon/focusview/FaceInformationList;

    invoke-direct {v0}, Lcom/sonyericsson/cameracommon/focusview/FaceInformationList;-><init>()V

    .line 216
    invoke-virtual {v0, p2}, Lcom/sonyericsson/cameracommon/focusview/FaceInformationList;->setUserTouchUuid(Ljava/lang/String;)V
    ...
    .line 223
    iget v1, p2, Lcom/sonyericsson/android/camera/device/CameraParameters$ExtFace;->id:I
    ...
    .line 228
    new-instance v1, Lcom/sonyericsson/cameracommon/focusview/NamedFace;

    iget-object v5, p2, Lcom/sonyericsson/android/camera/device/CameraParameters$ExtFace;->rect:Landroid/graphics/Rect;

    iget-object v6, p2, Lcom/sonyericsson/android/camera/device/CameraParameters$ExtFace;->eyePosition:Landroid/graphics/Point;

    iget v7, p2, Lcom/sonyericsson/android/camera/device/CameraParameters$ExtFace;->smileScore:I

    iget-boolean v8, p2, Lcom/sonyericsson/android/camera/device/CameraParameters$ExtFace;->isAnimalFace:Z

    move-object v2, v1

    invoke-direct/range {v2 .. v8}, Lcom/sonyericsson/cameracommon/focusview/NamedFace;-><init>(Ljava/lang/String;Ljava/lang/String;Landroid/graphics/Rect;Landroid/graphics/Point;IZ)V

    .line 236
    invoke-virtual {v0, v1}, Lcom/sonyericsson/cameracommon/focusview/FaceInformationList;->addNamedFace(Lcom/sonyericsson/cameracommon/focusview/NamedFace;)V
...
.method public static logFaceDetectionResult(Lcom/sonyericsson/android/camera/device/CameraParameters$FaceDetectionResult;)V
    ...
    iget-object v4, v2, Lcom/sonyericsson/android/camera/device/CameraParameters$ExtFace;->eyePosition:Landroid/graphics/Point;
    ...
    iget v4, v2, Lcom/sonyericsson/android/camera/device/CameraParameters$ExtFace;->smileScore:I
    ...
    const-string v4, " isAnimalFace = "

    invoke-virtual {v5, v4}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    iget-boolean v2, v2, Lcom/sonyericsson/android/camera/device/CameraParameters$ExtFace;->isAnimalFace:Z
