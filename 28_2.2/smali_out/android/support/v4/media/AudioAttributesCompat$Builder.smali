...
.method public build()Landroid/support/v4/media/AudioAttributesCompat;
    ...
    iget p0, p0, Landroid/support/v4/media/AudioAttributesCompat$Builder;->mLegacyStream:I

    invoke-direct {v1, v0, p0}, Landroid/support/v4/media/AudioAttributesImplApi21;-><init>(Landroid/media/AudioAttributes;I)V
    ...
    invoke-direct {v1, v0, v2, v3, p0}, Landroid/support/v4/media/AudioAttributesImplBase;-><init>(IIII)V

    .line 438
    :goto_44
    new-instance p0, Landroid/support/v4/media/AudioAttributesCompat;

    invoke-direct {p0, v1}, Landroid/support/v4/media/AudioAttributesCompat;-><init>(Landroid/support/v4/media/AudioAttributesImpl;)V
