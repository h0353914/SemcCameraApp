...
.method public static zza(Landroid/accounts/Account;Ljava/util/ArrayList;[Ljava/lang/String;ZLjava/lang/String;Ljava/lang/String;[Ljava/lang/String;Landroid/os/Bundle;ZIIZ)Landroid/content/Intent;
    ...
    const-string p11, "com.google.android.gms.common.account.CHOOSE_ACCOUNT_USERTILE"

    goto :goto_c

    :cond_a
    const-string p11, "com.google.android.gms.common.account.CHOOSE_ACCOUNT"

    :goto_c
    invoke-virtual {v0, p11}, Landroid/content/Intent;->setAction(Ljava/lang/String;)Landroid/content/Intent;

    const-string p11, "com.google.android.gms"

    invoke-virtual {v0, p11}, Landroid/content/Intent;->setPackage(Ljava/lang/String;)Landroid/content/Intent;

    const-string p11, "allowableAccounts"

    invoke-virtual {v0, p11, p1}, Landroid/content/Intent;->putExtra(Ljava/lang/String;Ljava/io/Serializable;)Landroid/content/Intent;
