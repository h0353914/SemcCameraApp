...
.method private assertInputTensor(Ljava/lang/String;Lcom/qualcomm/qti/snpe/Tensor;)V
    ...
    .line 439
    :cond_22
    new-instance p2, Lcom/qualcomm/qti/snpe/NeuralNetwork$InvalidInput;

    new-instance v0, Ljava/lang/StringBuilder;

    invoke-direct {v0}, Ljava/lang/StringBuilder;-><init>()V

    const-string v1, "Tensor not amongst network input tensors: "
    ...
    invoke-direct {p2, p1}, Lcom/qualcomm/qti/snpe/NeuralNetwork$InvalidInput;-><init>(Ljava/lang/String;)V

    throw p2

    .line 435
    :cond_39
    new-instance p1, Lcom/qualcomm/qti/snpe/NeuralNetwork$InvalidInput;

    new-instance p2, Ljava/lang/StringBuilder;

    invoke-direct {p2}, Ljava/lang/StringBuilder;-><init>()V

    const-string v0, "Input Tensor must be an instance of "

    invoke-virtual {p2, v0}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    const-class v0, Lcom/qualcomm/qti/snpe/internal/NativeFloatTensor;
    ...
    invoke-direct {p1, p2}, Lcom/qualcomm/qti/snpe/NeuralNetwork$InvalidInput;-><init>(Ljava/lang/String;)V
    ...
    const-string v1, "Tensor can not be null: "
...
.method private assertInputTensor(Ljava/lang/String;Lcom/qualcomm/qti/snpe/UserBufferTensor;)V
    ...
    const-class v0, Lcom/qualcomm/qti/snpe/internal/NativeUserBufferHandle;
...
.method private assertOutputTensor(Ljava/lang/String;Lcom/qualcomm/qti/snpe/UserBufferTensor;)V
    ...
    const-string v1, "Tensor not amongst network output tensors: "
    ...
    const-string v0, "Output Tensor must be an instance of "
...
.method private readUserBufferTensor(Lcom/qualcomm/qti/snpe/internal/util/JniOutputBundle;Lcom/qualcomm/qti/snpe/UserBufferTensor;)V
    ...
    const-string p2, "UserBuffer tensor encodings do not match"
...
.method public varargs createFloatTensor([I)Lcom/qualcomm/qti/snpe/FloatTensor;
    ...
    const-string v0, "Shape dimension can not be < 1!"
    ...
    const-string v0, "Tensor shape can not be null or empty!"
...
.method public createTF8UserBufferTensor(I[IIFLjava/nio/ByteBuffer;)Lcom/qualcomm/qti/snpe/TF8UserBufferTensor;
    ...
    const-string p2, "Strides can not be less than 1"
    ...
    const-string p2, "Buffer must be allocated, not null"
    ...
    const-string p2, "Step size has to be a positive value"
    ...
    const-string p2, "Step representing 0.0 has to be a valid 8-bit value"
    ...
    const-string p2, "Buffer size has to be greater than 0"
...
.method public execute(Ljava/util/Map;)Ljava/util/Map;
    ...
    const-string v4, "Network forward took "
    ...
    const-string v0, "Input tensor map can not be null or empty!"

    invoke-direct {p1, v0}, Lcom/qualcomm/qti/snpe/NeuralNetwork$InvalidInput;-><init>(Ljava/lang/String;)V
...
.method public execute(Ljava/util/Map;Ljava/util/Map;)Z
    ...
    const-string v6, "Network forward took "
    ...
    const-string p2, "Output tensor map can not be null or empty"
    ...
    const-string p2, "Input tensor map can not be null or empty!"
