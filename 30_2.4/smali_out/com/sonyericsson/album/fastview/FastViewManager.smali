...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    .line 89
    :catch_38
    new-instance p1, Lcom/sonyericsson/album/fastview/FastViewUnavailableException;

    invoke-direct {p1}, Lcom/sonyericsson/album/fastview/FastViewUnavailableException;-><init>()V
...
.method public getBitmap(Landroid/net/Uri;)Landroid/graphics/Bitmap;
    ...
    iget-object v5, p0, Lcom/sonyericsson/album/fastview/FastViewManager;->mContext:Landroid/content/Context;
...
.method public prepare(Landroid/net/Uri;)V
    ...
    :cond_7
    :try_start_7
    invoke-interface {v0, p1}, Lcom/sonyericsson/album/fastview/IFastViewService;->prepare(Landroid/net/Uri;)V
    :try_end_a
    ...
    :catch_b
    const-string p1, "FastViewManager"

    const-string v0, "Not in pre-warmed state."
