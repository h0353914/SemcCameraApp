...
.method entry()V
    ...
    # getter for: Lcom/sonyericsson/android/camera/controller/GestureShutter;->mPreviewFrameProvider:Lcom/sonyericsson/android/camera/device/PreviewFrameProvider;
    invoke-static {v1}, Lcom/sonyericsson/android/camera/controller/GestureShutter;->access$1200(Lcom/sonyericsson/android/camera/controller/GestureShutter;)Lcom/sonyericsson/android/camera/device/PreviewFrameProvider;

    move-result-object v1

    invoke-interface {v0, v1}, Lcom/sonyericsson/android/camera/gestureshutter/HandSignsDetectorInterface;->startDetect(Lcom/sonyericsson/android/camera/device/PreviewFrameProvider;)V
    ...
    # getter for: Lcom/sonyericsson/android/camera/controller/GestureShutter;->mLayoutOrientation:Lcom/sonyericsson/android/camera/CameraActivity$LayoutOrientation;
    invoke-static {v1}, Lcom/sonyericsson/android/camera/controller/GestureShutter;->access$100(Lcom/sonyericsson/android/camera/controller/GestureShutter;)Lcom/sonyericsson/android/camera/CameraActivity$LayoutOrientation;

    move-result-object v1

    invoke-interface {v0, v1}, Lcom/sonyericsson/android/camera/gestureshutter/HandSignsDetectorInterface;->setLayoutOrientation(Lcom/sonyericsson/android/camera/CameraActivity$LayoutOrientation;)V
...
.method handleDetectResult(Lcom/sonyericsson/android/camera/gestureshutter/HandSignsDetectorInterface$DetectResultInterface;)V
    ...
    invoke-interface {v0}, Lcom/sonyericsson/android/camera/controller/GestureShutter$WindowHost;->canShowGestureShutterView()Z
    ...
    invoke-direct {v1, v0, p1}, Lcom/sonyericsson/android/camera/controller/GestureShutter$StateRecognitionProceeding;-><init>(Lcom/sonyericsson/android/camera/controller/GestureShutter;Landroid/graphics/RectF;)V
