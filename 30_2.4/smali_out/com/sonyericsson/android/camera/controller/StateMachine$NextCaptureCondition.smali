...
.method static constructor <clinit>()V
    ...
    invoke-direct {v0, v1, v3}, Lcom/sonyericsson/android/camera/controller/StateMachine$NextCaptureCondition;-><init>(Ljava/lang/String;I)V

    sput-object v0, Lcom/sonyericsson/android/camera/controller/StateMachine$NextCaptureCondition;->REQUESTED:Lcom/sonyericsson/android/camera/controller/StateMachine$NextCaptureCondition;
    ...
    invoke-direct {v0, v1, v4}, Lcom/sonyericsson/android/camera/controller/StateMachine$NextCaptureCondition;-><init>(Ljava/lang/String;I)V

    sput-object v0, Lcom/sonyericsson/android/camera/controller/StateMachine$NextCaptureCondition;->UNACCEPTABLE:Lcom/sonyericsson/android/camera/controller/StateMachine$NextCaptureCondition;

    const/4 v0, 0x3

    .line 4893
    new-array v0, v0, [Lcom/sonyericsson/android/camera/controller/StateMachine$NextCaptureCondition;

    sget-object v1, Lcom/sonyericsson/android/camera/controller/StateMachine$NextCaptureCondition;->READY:Lcom/sonyericsson/android/camera/controller/StateMachine$NextCaptureCondition;

    aput-object v1, v0, v2

    sget-object v1, Lcom/sonyericsson/android/camera/controller/StateMachine$NextCaptureCondition;->REQUESTED:Lcom/sonyericsson/android/camera/controller/StateMachine$NextCaptureCondition;

    aput-object v1, v0, v3

    sget-object v1, Lcom/sonyericsson/android/camera/controller/StateMachine$NextCaptureCondition;->UNACCEPTABLE:Lcom/sonyericsson/android/camera/controller/StateMachine$NextCaptureCondition;

    aput-object v1, v0, v4

    sput-object v0, Lcom/sonyericsson/android/camera/controller/StateMachine$NextCaptureCondition;->$VALUES:[Lcom/sonyericsson/android/camera/controller/StateMachine$NextCaptureCondition;
