.class synthetic Lcom/sonyericsson/android/camera/faultdetection/DetectorBase$1;
...
.field static final synthetic $SwitchMap$com$sonyericsson$android$camera$configuration$parameters$FaultDetection:[I
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lcom/sonyericsson/android/camera/faultdetection/DetectorBase$1;->$SwitchMap$com$sonyericsson$android$camera$configuration$parameters$FaultDetection:[I

    const/4 v0, 0x1

    :try_start_a
    sget-object v1, Lcom/sonyericsson/android/camera/faultdetection/DetectorBase$1;->$SwitchMap$com$sonyericsson$android$camera$configuration$parameters$FaultDetection:[I

    sget-object v2, Lcom/sonyericsson/android/camera/configuration/parameters/FaultDetection;->SNAPSHOT_AND_PREVIEW:Lcom/sonyericsson/android/camera/configuration/parameters/FaultDetection;

    invoke-virtual {v2}, Lcom/sonyericsson/android/camera/configuration/parameters/FaultDetection;->ordinal()I
    ...
    :try_start_15
    sget-object v2, Lcom/sonyericsson/android/camera/faultdetection/DetectorBase$1;->$SwitchMap$com$sonyericsson$android$camera$configuration$parameters$FaultDetection:[I

    sget-object v3, Lcom/sonyericsson/android/camera/configuration/parameters/FaultDetection;->SNAPSHOT_ONLY:Lcom/sonyericsson/android/camera/configuration/parameters/FaultDetection;

    invoke-virtual {v3}, Lcom/sonyericsson/android/camera/configuration/parameters/FaultDetection;->ordinal()I
    ...
    :try_start_20
    sget-object v3, Lcom/sonyericsson/android/camera/faultdetection/DetectorBase$1;->$SwitchMap$com$sonyericsson$android$camera$configuration$parameters$FaultDetection:[I

    sget-object v4, Lcom/sonyericsson/android/camera/configuration/parameters/FaultDetection;->OFF:Lcom/sonyericsson/android/camera/configuration/parameters/FaultDetection;

    invoke-virtual {v4}, Lcom/sonyericsson/android/camera/configuration/parameters/FaultDetection;->ordinal()I
    ...
    sput-object v3, Lcom/sonyericsson/android/camera/faultdetection/DetectorBase$1;->$SwitchMap$com$sonyericsson$android$camera$configuration$parameters$CapturingMode:[I

    :try_start_33
    sget-object v3, Lcom/sonyericsson/android/camera/faultdetection/DetectorBase$1;->$SwitchMap$com$sonyericsson$android$camera$configuration$parameters$CapturingMode:[I
