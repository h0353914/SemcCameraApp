...
.method private shutdownEncodedDataThreadPool()V
    ...
    .line 325
    iget-object v0, p0, Lcom/sonyericsson/android/camera/recorder/utility/encoder/MediaEncoder;->mInputEncodedDataThreadPool:Ljava/util/concurrent/ExecutorService;
...
.method public release()V
    ...
    :catch_d
    const-string v0, "IllegalStateException occur at releaseMuxer()."
...
.method releaseEncoders()V
    ...
    .line 347
    iget-object v3, v3, Lcom/sonyericsson/android/camera/recorder/utility/encoder/InputDataInfo;->codec:Landroid/media/MediaCodec;
    ...
    const-string v0, "releaseEncoders() X"
...
.method releaseMuxer()V
    ...
    invoke-virtual {v0}, Lcom/sonyericsson/android/camera/recorder/utility/encoder/MediaMuxerWrapper;->release()V
    ...
    const-string v0, "releaseMuxer() X"
...
.method sendOnErrorEvent(I)V
    ...
    .line 422
    invoke-virtual {v0, p1}, Lcom/sonyericsson/android/camera/recorder/utility/encoder/MediaEncoder$EncodingStateNotifier;->notifyOnError(I)V
...
.method sendOnFinishedEvent(Z)V
    ...
    .line 416
    invoke-virtual {v0, p1}, Lcom/sonyericsson/android/camera/recorder/utility/encoder/MediaEncoder$EncodingStateNotifier;->notifyOnFinished(Z)V
...
.method sendOnStartedEvent()V
    ...
    .line 407
    invoke-virtual {v0}, Lcom/sonyericsson/android/camera/recorder/utility/encoder/MediaEncoder$EncodingStateNotifier;->notifyOnStarted()V
...
.method public setLocation(FF)V
    ...
    invoke-virtual {v0, p1, p2}, Lcom/sonyericsson/android/camera/recorder/utility/encoder/MediaMuxerWrapper;->setLocation(FF)V
...
.method public setMaxDuration(J)V
    ...
    invoke-virtual {v0, p1, p2}, Lcom/sonyericsson/android/camera/recorder/utility/encoder/MediaMuxerWrapper;->setMaxDuration(J)V
...
.method public setMaxFileSize(J)V
    ...
    invoke-virtual {v0, p1, p2}, Lcom/sonyericsson/android/camera/recorder/utility/encoder/MediaMuxerWrapper;->setMaxFileSize(J)V
...
.method public setOrientationHint(I)V
    ...
    invoke-virtual {v0, p1}, Lcom/sonyericsson/android/camera/recorder/utility/encoder/MediaMuxerWrapper;->setOrientationHint(I)V
...
.method public start()V
    ...
    iget-object v1, p0, Lcom/sonyericsson/android/camera/recorder/utility/encoder/MediaEncoder;->mMainTask:Ljava/lang/Runnable;
...
.method startEncodedDataWriteTasks()V
    ...
    const-string v0, "startEncodedDataWriteTasks() X"
...
.method startEncoders()V
    ...
    const-string v0, "startEncoders() X"
...
.method startInputDataSource()V
    ...
    invoke-interface {v3}, Lcom/sonyericsson/android/camera/recorder/utility/encoder/InputDataSource;->start()V
...
.method startMediaMuxerAfterEncodedFormatIsFixed()V
    ...
    .line 308
    :cond_31
    iget-object v0, p0, Lcom/sonyericsson/android/camera/recorder/utility/encoder/MediaEncoder;->mMuxerStartedSignal:Ljava/util/concurrent/CountDownLatch;
    ...
    const-string v0, "startMediaMuxer() X"
...
.method stopEncoders()V
    ...
    const-string v0, "stopEncoders() X"
...
.method stopInputDataSource()V
    ...
    invoke-interface {v3}, Lcom/sonyericsson/android/camera/recorder/utility/encoder/InputDataSource;->stop()V
...
.method stopMuxer()V
    ...
    invoke-virtual {v0}, Lcom/sonyericsson/android/camera/recorder/utility/encoder/MediaMuxerWrapper;->stop()V
...
.method waitToCompleteEncoding()V
    ...
    .line 391
    :cond_26
    iget-object v2, p0, Lcom/sonyericsson/android/camera/recorder/utility/encoder/MediaEncoder;->mEncoderFinishSignal:Ljava/util/concurrent/CountDownLatch;
    ...
    const-string v2, "EncoderFinishSignal.await FINISHED"
    ...
    invoke-static {v2}, Lcom/sonyericsson/android/camera/util/CamLog;->d([Ljava/lang/String;)V
    :try_end_38
    .catch Ljava/lang/InterruptedException; {:try_start_19 .. :try_end_38} :catch_39

    goto :goto_42

    :catch_39
    const-string v2, "mEncoderFinishSignal is interrupted"
    ...
    const-string v0, "waitToCompleteEncoding() X"
