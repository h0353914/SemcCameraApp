...
.field public static final enum CANNOT_BURST_DUE_TO_SHUTTER_SPEED:Lcom/sonyericsson/android/camera/view/ViewFinder$BurstRejectedReason;

.field public static final enum CANNOT_BURST_DUE_TO_TAGGING_MODE:Lcom/sonyericsson/android/camera/view/ViewFinder$BurstRejectedReason;

.field public static final enum CANNOT_BURST_DUE_TO_WIDE_MODE:Lcom/sonyericsson/android/camera/view/ViewFinder$BurstRejectedReason;
...
.method static constructor <clinit>()V
    ...
    const-string v1, "CANNOT_BURST_DUE_TO_SHUTTER_SPEED"

    const/4 v7, 0x5

    invoke-direct {v0, v1, v7}, Lcom/sonyericsson/android/camera/view/ViewFinder$BurstRejectedReason;-><init>(Ljava/lang/String;I)V

    sput-object v0, Lcom/sonyericsson/android/camera/view/ViewFinder$BurstRejectedReason;->CANNOT_BURST_DUE_TO_SHUTTER_SPEED:Lcom/sonyericsson/android/camera/view/ViewFinder$BurstRejectedReason;
    ...
    const-string v1, "CANNOT_BURST_DUE_TO_WIDE_MODE"

    const/4 v9, 0x7

    invoke-direct {v0, v1, v9}, Lcom/sonyericsson/android/camera/view/ViewFinder$BurstRejectedReason;-><init>(Ljava/lang/String;I)V

    sput-object v0, Lcom/sonyericsson/android/camera/view/ViewFinder$BurstRejectedReason;->CANNOT_BURST_DUE_TO_WIDE_MODE:Lcom/sonyericsson/android/camera/view/ViewFinder$BurstRejectedReason;

    .line 269
    new-instance v0, Lcom/sonyericsson/android/camera/view/ViewFinder$BurstRejectedReason;

    const-string v1, "CANNOT_BURST_DUE_TO_TAGGING_MODE"

    const/16 v10, 0x8

    invoke-direct {v0, v1, v10}, Lcom/sonyericsson/android/camera/view/ViewFinder$BurstRejectedReason;-><init>(Ljava/lang/String;I)V

    sput-object v0, Lcom/sonyericsson/android/camera/view/ViewFinder$BurstRejectedReason;->CANNOT_BURST_DUE_TO_TAGGING_MODE:Lcom/sonyericsson/android/camera/view/ViewFinder$BurstRejectedReason;
    ...
    sget-object v1, Lcom/sonyericsson/android/camera/view/ViewFinder$BurstRejectedReason;->CANNOT_BURST_DUE_TO_SHUTTER_SPEED:Lcom/sonyericsson/android/camera/view/ViewFinder$BurstRejectedReason;
    ...
    sget-object v1, Lcom/sonyericsson/android/camera/view/ViewFinder$BurstRejectedReason;->CANNOT_BURST_DUE_TO_WIDE_MODE:Lcom/sonyericsson/android/camera/view/ViewFinder$BurstRejectedReason;

    aput-object v1, v0, v9

    sget-object v1, Lcom/sonyericsson/android/camera/view/ViewFinder$BurstRejectedReason;->CANNOT_BURST_DUE_TO_TAGGING_MODE:Lcom/sonyericsson/android/camera/view/ViewFinder$BurstRejectedReason;
