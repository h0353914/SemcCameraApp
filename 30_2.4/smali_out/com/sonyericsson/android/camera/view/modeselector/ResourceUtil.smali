...
.method public static getBitmap(Landroid/content/Context;Ljava/lang/String;III)Landroid/graphics/Bitmap;
    ...
    move-result-object p0
    :try_end_26
    .catch Landroid/content/pm/PackageManager$NameNotFoundException; {:try_start_7 .. :try_end_26} :catch_7a
    .catch Landroid/content/res/Resources$NotFoundException; {:try_start_7 .. :try_end_26} :catch_75
    .catch Ljava/lang/OutOfMemoryError; {:try_start_7 .. :try_end_26} :catch_70
    ...
    move-result-object p0
    :try_end_2c
    .catch Landroid/content/pm/PackageManager$NameNotFoundException; {:try_start_28 .. :try_end_2c} :catch_33
    .catch Landroid/content/res/Resources$NotFoundException; {:try_start_28 .. :try_end_2c} :catch_30
    .catch Ljava/lang/OutOfMemoryError; {:try_start_28 .. :try_end_2c} :catch_2d
    ...
    :try_end_6f
    .catch Landroid/content/pm/PackageManager$NameNotFoundException; {:try_start_36 .. :try_end_6f} :catch_7a
    .catch Landroid/content/res/Resources$NotFoundException; {:try_start_36 .. :try_end_6f} :catch_75
    .catch Ljava/lang/OutOfMemoryError; {:try_start_36 .. :try_end_6f} :catch_70
...
.method private static getRemoteBitmap(Ljava/lang/String;II)Landroid/graphics/Bitmap;
    ...
    :try_end_e
    .catch Ljava/net/MalformedURLException; {:try_start_3 .. :try_end_e} :catch_9a
    .catch Ljava/io/IOException; {:try_start_3 .. :try_end_e} :catch_76
    ...
    .catchall {:try_start_11 .. :try_end_17} :catchall_be
    ...
    .catchall {:try_start_3b .. :try_end_41} :catchall_be
    ...
    :try_end_94
    .catchall {:try_start_78 .. :try_end_94} :catchall_be
    ...
    invoke-static {p2}, Lcom/sonyericsson/android/camera/util/CamLog;->e([Ljava/lang/String;)V
    :try_end_b8
    .catchall {:try_start_9c .. :try_end_b8} :catchall_be
...
.method public static getString(Landroid/content/Context;Ljava/lang/String;ILjava/lang/String;I)Ljava/lang/String;
    ...
    move-result-object p3
    :try_end_18
    .catch Landroid/content/res/Resources$NotFoundException; {:try_start_1 .. :try_end_18} :catch_1e
    .catch Ljava/lang/OutOfMemoryError; {:try_start_1 .. :try_end_18} :catch_1c
