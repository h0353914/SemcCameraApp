...
.method private analyzeOldTiff(Ljava/util/Map;)Ljava/util/List;
    ...
    invoke-virtual {v2, v0, v3, v1}, Lorg/apache/commons/imaging/formats/tiff/TiffReader;->readContents(Lorg/apache/commons/imaging/common/bytesource/ByteSource;Ljava/util/Map;Lorg/apache/commons/imaging/FormatCompliance;)Lorg/apache/commons/imaging/formats/tiff/TiffContents;
    ...
    .line 89
    invoke-virtual {v5}, Lorg/apache/commons/imaging/formats/tiff/TiffField;->getTag()I
    ...
    check-cast v7, Lorg/apache/commons/imaging/formats/tiff/write/TiffOutputField;

    if-eqz v7, :cond_77

    .line 90
    invoke-virtual {v7}, Lorg/apache/commons/imaging/formats/tiff/write/TiffOutputField;->getSeperateValue()Lorg/apache/commons/imaging/formats/tiff/write/TiffOutputItem;

    move-result-object v8

    if-eqz v8, :cond_77

    invoke-virtual {v5}, Lorg/apache/commons/imaging/formats/tiff/TiffField;->getByteArrayValue()[B

    move-result-object v8

    invoke-virtual {v7, v8}, Lorg/apache/commons/imaging/formats/tiff/write/TiffOutputField;->bytesEqual([B)Z
    ...
    invoke-virtual {v5}, Lorg/apache/commons/imaging/formats/tiff/TiffField;->getOffset()I

    move-result v5

    int-to-long v7, v5

    invoke-virtual {v6, v7, v8}, Lorg/apache/commons/imaging/formats/tiff/write/TiffOutputItem;->setOffset(J)V
    ...
    check-cast v1, Lorg/apache/commons/imaging/formats/tiff/TiffElement;

    .line 123
    iget-wide v6, v1, Lorg/apache/commons/imaging/formats/tiff/TiffElement;->offset:J

    iget v2, v1, Lorg/apache/commons/imaging/formats/tiff/TiffElement;->length:I
    ...
    .line 127
    :cond_b7
    iget-wide v8, v1, Lorg/apache/commons/imaging/formats/tiff/TiffElement;->offset:J
    ...
    iget-wide v8, v3, Lorg/apache/commons/imaging/formats/tiff/TiffElement;->offset:J
    ...
    invoke-direct {v2, v8, v9, v3}, Lorg/apache/commons/imaging/formats/tiff/TiffElement$Stub;-><init>(JI)V
    ...
    invoke-direct {v0, v1, v2, v3}, Lorg/apache/commons/imaging/formats/tiff/TiffElement$Stub;-><init>(JI)V

    invoke-interface {p1, v0}, Ljava/util/List;->add(Ljava/lang/Object;)Z
    :try_end_e1
    .catch Lorg/apache/commons/imaging/ImageReadException; {:try_start_0 .. :try_end_e1} :catch_e2
    ...
    invoke-virtual {p1}, Lorg/apache/commons/imaging/ImageReadException;->getMessage()Ljava/lang/String;
...
.method private updateOffsetsStep(Ljava/util/List;Ljava/util/List;)J
    ...
    .line 216
    iget-wide v4, p1, Lorg/apache/commons/imaging/formats/tiff/TiffElement;->offset:J

    iget v6, p1, Lorg/apache/commons/imaging/formats/tiff/TiffElement;->length:I
    ...
    check-cast v7, Lorg/apache/commons/imaging/formats/tiff/TiffElement;

    .line 243
    iget v8, v7, Lorg/apache/commons/imaging/formats/tiff/TiffElement;->length:I
    ...
    .line 254
    :cond_74
    iget-wide v6, v5, Lorg/apache/commons/imaging/formats/tiff/TiffElement;->offset:J

    invoke-virtual {p2, v6, v7}, Lorg/apache/commons/imaging/formats/tiff/write/TiffOutputItem;->setOffset(J)V

    .line 255
    invoke-interface {v2, v5}, Ljava/util/List;->remove(Ljava/lang/Object;)Z

    .line 257
    iget p2, v5, Lorg/apache/commons/imaging/formats/tiff/TiffElement;->length:I
    ...
    .line 261
    new-instance v4, Lorg/apache/commons/imaging/formats/tiff/TiffElement$Stub;

    invoke-direct {v4, v6, v7, p2}, Lorg/apache/commons/imaging/formats/tiff/TiffElement$Stub;-><init>(JI)V
