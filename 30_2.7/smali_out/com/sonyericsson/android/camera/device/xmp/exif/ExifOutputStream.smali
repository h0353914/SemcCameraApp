...
.method private calculateAllOffset()I
    ...
    invoke-virtual {v3, v1}, Lcom/sonyericsson/android/camera/device/xmp/exif/IfdData;->getTag(S)Lcom/sonyericsson/android/camera/device/xmp/exif/ExifTag;

    move-result-object v1

    invoke-virtual {v1, v0}, Lcom/sonyericsson/android/camera/device/xmp/exif/ExifTag;->setValue([J)Z
...
.method private calculateOffsetOfIfd(Lcom/sonyericsson/android/camera/device/xmp/exif/IfdData;I)I
    ...
    .line 322
    invoke-virtual {v3}, Lcom/sonyericsson/android/camera/device/xmp/exif/ExifTag;->getDataSize()I
    ...
    .line 323
    invoke-virtual {v3, p2}, Lcom/sonyericsson/android/camera/device/xmp/exif/ExifTag;->setOffset(I)V
...
.method private createRequiredIfdAndTag()V
    ...
    invoke-virtual {v2, v3}, Lcom/sonyericsson/android/camera/device/xmp/exif/ExifData;->getIfdData(I)Lcom/sonyericsson/android/camera/device/xmp/exif/IfdData;
    ...
    invoke-direct {v2, v3}, Lcom/sonyericsson/android/camera/device/xmp/exif/IfdData;-><init>(I)V

    .line 348
    iget-object v3, p0, Lcom/sonyericsson/android/camera/device/xmp/exif/ExifOutputStream;->mExifData:Lcom/sonyericsson/android/camera/device/xmp/exif/ExifData;

    invoke-virtual {v3, v2}, Lcom/sonyericsson/android/camera/device/xmp/exif/ExifData;->addIfdData(Lcom/sonyericsson/android/camera/device/xmp/exif/IfdData;)V
    ...
    .line 354
    iget-object v3, p0, Lcom/sonyericsson/android/camera/device/xmp/exif/ExifOutputStream;->mInterface:Lcom/sonyericsson/android/camera/device/xmp/exif/ExifInterface;

    sget v4, Lcom/sonyericsson/android/camera/device/xmp/exif/ExifInterface;->TAG_GPS_IFD:I

    invoke-virtual {v3, v4}, Lcom/sonyericsson/android/camera/device/xmp/exif/ExifInterface;->buildUninitializedTag(I)Lcom/sonyericsson/android/camera/device/xmp/exif/ExifTag;
    ...
    .line 359
    invoke-virtual {v0, v3}, Lcom/sonyericsson/android/camera/device/xmp/exif/IfdData;->setTag(Lcom/sonyericsson/android/camera/device/xmp/exif/ExifTag;)Lcom/sonyericsson/android/camera/device/xmp/exif/ExifTag;
    ...
    invoke-virtual {v0, v3}, Lcom/sonyericsson/android/camera/device/xmp/exif/ExifData;->getIfdData(I)Lcom/sonyericsson/android/camera/device/xmp/exif/IfdData;
    ...
    .line 366
    invoke-virtual {v0, v3}, Lcom/sonyericsson/android/camera/device/xmp/exif/ExifInterface;->buildUninitializedTag(I)Lcom/sonyericsson/android/camera/device/xmp/exif/ExifTag;
    ...
    invoke-virtual {v3}, Lcom/sonyericsson/android/camera/device/xmp/exif/ExifData;->hasCompressedThumbnail()Z
    ...
    invoke-virtual {v2}, Lcom/sonyericsson/android/camera/device/xmp/exif/ExifData;->getCompressedThumbnail()[B

    move-result-object v2

    array-length v2, v2

    invoke-virtual {v1, v2}, Lcom/sonyericsson/android/camera/device/xmp/exif/ExifTag;->setValue(I)Z
    ...
    invoke-virtual {v0, v1}, Lcom/sonyericsson/android/camera/device/xmp/exif/IfdData;->removeTag(S)V
    ...
    invoke-virtual {v3}, Lcom/sonyericsson/android/camera/device/xmp/exif/ExifData;->hasUncompressedStrip()Z
    ...
    .line 423
    :goto_148
    iget-object v5, p0, Lcom/sonyericsson/android/camera/device/xmp/exif/ExifOutputStream;->mExifData:Lcom/sonyericsson/android/camera/device/xmp/exif/ExifData;

    invoke-virtual {v5}, Lcom/sonyericsson/android/camera/device/xmp/exif/ExifData;->getStripCount()I
    ...
    invoke-virtual {v5, v1}, Lcom/sonyericsson/android/camera/device/xmp/exif/ExifData;->getStrip(I)[B
    ...
    .line 426
    :cond_15d
    invoke-virtual {v4, v2}, Lcom/sonyericsson/android/camera/device/xmp/exif/ExifTag;->setValue([J)Z
    ...
    sget v2, Lcom/sonyericsson/android/camera/device/xmp/exif/ExifInterface;->TAG_STRIP_BYTE_COUNTS:I
...
.method private requestByteToBuffer(I[BII)I
    ...
    .line 111
    :goto_b
    iget-object p4, p0, Lcom/sonyericsson/android/camera/device/xmp/exif/ExifOutputStream;->mBuffer:Ljava/nio/ByteBuffer;
...
.method private stripNullValueTags(Lcom/sonyericsson/android/camera/device/xmp/exif/ExifData;)Ljava/util/ArrayList;
    ...
    check-cast v2, Lcom/sonyericsson/android/camera/device/xmp/exif/ExifTag;

    .line 255
    invoke-virtual {v2}, Lcom/sonyericsson/android/camera/device/xmp/exif/ExifTag;->getValue()Ljava/lang/Object;

    move-result-object v3

    if-nez v3, :cond_d

    invoke-virtual {v2}, Lcom/sonyericsson/android/camera/device/xmp/exif/ExifTag;->getTagId()S

    move-result v3

    invoke-static {v3}, Lcom/sonyericsson/android/camera/device/xmp/exif/ExifInterface;->isOffsetTag(S)Z
    ...
    invoke-virtual {v2}, Lcom/sonyericsson/android/camera/device/xmp/exif/ExifTag;->getIfd()I

    move-result v4

    invoke-virtual {p1, v3, v4}, Lcom/sonyericsson/android/camera/device/xmp/exif/ExifData;->removeTag(SI)V
...
.method private writeIfd(Lcom/sonyericsson/android/camera/device/xmp/exif/IfdData;Lcom/sonyericsson/android/camera/device/xmp/exif/OrderedDataOutputStream;)V
    ...
    invoke-virtual {p2, v1}, Lcom/sonyericsson/android/camera/device/xmp/exif/OrderedDataOutputStream;->writeShort(S)Lcom/sonyericsson/android/camera/device/xmp/exif/OrderedDataOutputStream;
    ...
    .line 295
    invoke-virtual {v5}, Lcom/sonyericsson/android/camera/device/xmp/exif/ExifTag;->getTagId()S

    move-result v6

    invoke-virtual {p2, v6}, Lcom/sonyericsson/android/camera/device/xmp/exif/OrderedDataOutputStream;->writeShort(S)Lcom/sonyericsson/android/camera/device/xmp/exif/OrderedDataOutputStream;

    .line 296
    invoke-virtual {v5}, Lcom/sonyericsson/android/camera/device/xmp/exif/ExifTag;->getDataType()S
    ...
    .line 297
    invoke-virtual {v5}, Lcom/sonyericsson/android/camera/device/xmp/exif/ExifTag;->getComponentCount()I

    move-result v6

    invoke-virtual {p2, v6}, Lcom/sonyericsson/android/camera/device/xmp/exif/OrderedDataOutputStream;->writeInt(I)Lcom/sonyericsson/android/camera/device/xmp/exif/OrderedDataOutputStream;

    .line 301
    invoke-virtual {v5}, Lcom/sonyericsson/android/camera/device/xmp/exif/ExifTag;->getDataSize()I
    ...
    .line 302
    invoke-virtual {v5}, Lcom/sonyericsson/android/camera/device/xmp/exif/ExifTag;->getOffset()I

    move-result v4

    invoke-virtual {p2, v4}, Lcom/sonyericsson/android/camera/device/xmp/exif/OrderedDataOutputStream;->writeInt(I)Lcom/sonyericsson/android/camera/device/xmp/exif/OrderedDataOutputStream;

    goto :goto_45

    .line 304
    :cond_34
    invoke-static {v5, p2}, Lcom/sonyericsson/android/camera/device/xmp/exif/ExifOutputStream;->writeTagValue(Lcom/sonyericsson/android/camera/device/xmp/exif/ExifTag;Lcom/sonyericsson/android/camera/device/xmp/exif/OrderedDataOutputStream;)V
    ...
    .line 306
    invoke-virtual {p2, v2}, Lcom/sonyericsson/android/camera/device/xmp/exif/OrderedDataOutputStream;->write(I)V
    ...
    .line 313
    invoke-static {v1, p2}, Lcom/sonyericsson/android/camera/device/xmp/exif/ExifOutputStream;->writeTagValue(Lcom/sonyericsson/android/camera/device/xmp/exif/ExifTag;Lcom/sonyericsson/android/camera/device/xmp/exif/OrderedDataOutputStream;)V
...
.method public write([BII)V
    ...
    .line 126
    iget v2, p0, Lcom/sonyericsson/android/camera/device/xmp/exif/ExifOutputStream;->mByteToSkip:I

    sub-int/2addr v2, v0

    iput v2, p0, Lcom/sonyericsson/android/camera/device/xmp/exif/ExifOutputStream;->mByteToSkip:I
    ...
    .line 165
    iget-object v3, p0, Lcom/sonyericsson/android/camera/device/xmp/exif/ExifOutputStream;->mBuffer:Ljava/nio/ByteBuffer;
    ...
    .line 168
    iget-object v3, p0, Lcom/sonyericsson/android/camera/device/xmp/exif/ExifOutputStream;->out:Ljava/io/OutputStream;
    ...
    .line 169
    iget v3, p0, Lcom/sonyericsson/android/camera/device/xmp/exif/ExifOutputStream;->mSize:I

    add-int/2addr v3, v1

    iput v3, p0, Lcom/sonyericsson/android/camera/device/xmp/exif/ExifOutputStream;->mSize:I
    ...
    .line 181
    :cond_97
    invoke-static {v3}, Lcom/sonyericsson/android/camera/device/xmp/exif/JpegHeader;->isSofMarker(S)Z
    ...
    .line 154
    iput v0, p0, Lcom/sonyericsson/android/camera/device/xmp/exif/ExifOutputStream;->mState:I
