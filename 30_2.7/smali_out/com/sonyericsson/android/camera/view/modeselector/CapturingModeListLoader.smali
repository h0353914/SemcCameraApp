...
.method public constructor <init>(Landroid/content/Context;[Lcom/sonyericsson/android/camera/view/modeselector/CapturingModeAttributes$InternalCaptureType;Lcom/sonyericsson/android/camera/view/modeselector/CapturingModeAttributes$VisibilityType;Lcom/sonyericsson/android/camera/view/modeselector/CapturingModeListLoader$OnCapturingModeListChangedListener;)V
    ...
    iget-object p4, p0, Lcom/sonyericsson/android/camera/view/modeselector/CapturingModeListLoader;->mContentObserver:Landroid/database/ContentObserver;

    invoke-virtual {p2, p3, p1, p4}, Landroid/content/ContentResolver;->registerContentObserver(Landroid/net/Uri;ZLandroid/database/ContentObserver;)V
    :try_end_38
    .catch Ljava/lang/SecurityException; {:try_start_2f .. :try_end_38} :catch_39
    ...
    const-string v0, "CapturingModeListLoader"
    ...
    const-string v0, "Guess com.sonymobile.camerauicommon.provider is not exists."
