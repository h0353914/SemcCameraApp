...
.method private attemptLayerFocusChange(I)V
    ...
    invoke-static {p1}, Lcom/sonyericsson/android/camera/view/sidetouch/SideTouchUi$IconLayer;->access$400(Lcom/sonyericsson/android/camera/view/sidetouch/SideTouchUi$IconLayer;)Z
    ...
    invoke-static {p1, v0}, Lcom/sonyericsson/android/camera/view/sidetouch/SideTouchUi$IconLayer;->access$502(Lcom/sonyericsson/android/camera/view/sidetouch/SideTouchUi$IconLayer;Z)Z
    ...
    invoke-static {p1}, Lcom/sonyericsson/android/camera/view/sidetouch/SideTouchUi$IconLayer;->access$300(Lcom/sonyericsson/android/camera/view/sidetouch/SideTouchUi$IconLayer;)Lcom/sonyericsson/android/camera/view/sidetouch/SideTouchUi$Icon;

    move-result-object v0

    # getter for: Lcom/sonyericsson/android/camera/view/sidetouch/SideTouchUi$IconLayer;->mFocused:Z
    invoke-static {p1}, Lcom/sonyericsson/android/camera/view/sidetouch/SideTouchUi$IconLayer;->access$500(Lcom/sonyericsson/android/camera/view/sidetouch/SideTouchUi$IconLayer;)Z

    move-result p1

    invoke-interface {v0, p1}, Lcom/sonyericsson/android/camera/view/sidetouch/SideTouchUi$Icon;->onFocusChanged(Z)V
...
.method private detachIcon(I)V
    ...
    invoke-interface {p1, v0}, Lcom/sonyericsson/android/camera/view/sidetouch/SideTouchUi$Icon;->detach(Landroid/view/ViewGroup;)V
...
.method private findNextIconLayer(IZ)Lcom/sonyericsson/android/camera/view/sidetouch/SideTouchUi$IconLayer;
    ...
    .line 418
    :cond_1a
    iget-object p2, p0, Lcom/sonyericsson/android/camera/view/sidetouch/SideTouchUi;->mIconLayer:Landroid/util/SparseArray;

    invoke-virtual {p2, p1}, Landroid/util/SparseArray;->get(I)Ljava/lang/Object;

    move-result-object p1

    check-cast p1, Lcom/sonyericsson/android/camera/view/sidetouch/SideTouchUi$IconLayer;
...
.method private getAttachPoint(I)Landroid/graphics/Point;
    ...
    # getter for: Lcom/sonyericsson/android/camera/view/sidetouch/SideTouchUi$IconLayer;->mAttachPoint:Landroid/graphics/Point;
    invoke-static {p1}, Lcom/sonyericsson/android/camera/view/sidetouch/SideTouchUi$IconLayer;->access$800(Lcom/sonyericsson/android/camera/view/sidetouch/SideTouchUi$IconLayer;)Landroid/graphics/Point;
...
.method private getIconType(I)Lcom/sonyericsson/android/camera/view/sidetouch/SideTouchUi$Type;
    ...
    invoke-static {p1}, Lcom/sonyericsson/android/camera/view/sidetouch/SideTouchUi$IconLayer;->access$700(Lcom/sonyericsson/android/camera/view/sidetouch/SideTouchUi$IconLayer;)Lcom/sonyericsson/android/camera/view/sidetouch/SideTouchUi$Type;
...
.method public showIcon()Z
    ...
    invoke-interface {v0}, Lcom/sonyericsson/android/camera/view/sidetouch/SideTouchUi$Icon;->show()V
