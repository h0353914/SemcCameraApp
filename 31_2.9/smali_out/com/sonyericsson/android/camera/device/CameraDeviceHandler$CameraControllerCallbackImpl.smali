...
.method public onAutoFlashResultChanged(Z)V
    ...
    # setter for: Lcom/sonyericsson/android/camera/device/CameraDeviceHandler;->mIsAutoFlashRequired:Z
    invoke-static {v0, p1}, Lcom/sonyericsson/android/camera/device/CameraDeviceHandler;->access$6602(Lcom/sonyericsson/android/camera/device/CameraDeviceHandler;Z)Z
...
.method public onAutoHdrResultChanged(Z)V
    ...
    const-string v3, "invoked isHdrDetected : "
    ...
    invoke-virtual {v0, p1}, Lcom/sonyericsson/android/camera/controller/StateMachine;->onAutoHdrResultChanged(Z)V
...
.method public onAutoNightResultChanged(Z)V
    ...
    const-string v3, "invoked isAutoNightDetected : "
    ...
    # setter for: Lcom/sonyericsson/android/camera/device/CameraDeviceHandler;->mIsAutoNightDetected:Z
    invoke-static {v0, p1}, Lcom/sonyericsson/android/camera/device/CameraDeviceHandler;->access$6702(Lcom/sonyericsson/android/camera/device/CameraDeviceHandler;Z)Z
...
.method public onFaceDetected(Lcom/sonyericsson/android/camera/device/CameraParameters$FaceDetectionResult;)V
    ...
    invoke-virtual {p1, v1}, Lcom/sonymobile/cameracommon/research/ResearchUtil;->setEyeDetected(Z)V
...
.method public onFirstPreviewFrameReceived()V
    ...
    invoke-virtual {v0}, Lcom/sonyericsson/android/camera/controller/StateMachine;->onFirstPreviewFrameReceived()V
...
.method public onHalDecideBackgroundTask(Z)V
    ...
    # invokes: Lcom/sonyericsson/android/camera/device/CameraDeviceHandler;->dequeueSavingPhotoRequestBackup()Lcom/sonyericsson/cameracommon/storage/RequestFactory$PhotoSavingRequestBuilder;
    invoke-static {v0}, Lcom/sonyericsson/android/camera/device/CameraDeviceHandler;->access$7000(Lcom/sonyericsson/android/camera/device/CameraDeviceHandler;)Lcom/sonyericsson/cameracommon/storage/RequestFactory$PhotoSavingRequestBuilder;
    ...
    invoke-static {p1}, Lcom/sonyericsson/android/camera/device/CameraDeviceHandler;->access$1100(Lcom/sonyericsson/android/camera/device/CameraDeviceHandler;)Lcom/sonyericsson/android/camera/device/virtual/VirtualCameraController;

    move-result-object p1

    invoke-interface {p1}, Lcom/sonyericsson/android/camera/device/virtual/VirtualCameraController;->capture()V
    ...
    invoke-static {p1}, Lcom/sonyericsson/android/camera/device/CameraDeviceHandler;->access$100(Lcom/sonyericsson/android/camera/device/CameraDeviceHandler;)V
...
.method public onLogicalCameraModeChanged()V
    ...
    invoke-virtual {v0, v1}, Lcom/sonyericsson/android/camera/controller/StateMachine;->onLogicalCameraModeChanged(Z)V
...
.method public onPreviewFrameReceived(I)V
    ...
    invoke-virtual {v0, p1}, Lcom/sonyericsson/android/camera/controller/StateMachine;->onPreviewFrameReceived(I)V
...
.method public onPreviewFrameUpdated(Ljava/nio/ByteBuffer;ILandroid/graphics/Rect;)V
    ...
    sget-object v3, Lcom/sonyericsson/android/camera/controller/StateMachine$TransitterEvent;->EVENT_ON_ONE_PREVIEW_FRAME_UPDATED:Lcom/sonyericsson/android/camera/controller/StateMachine$TransitterEvent;
    ...
    .line 5455
    invoke-virtual {p1, v3, v4}, Lcom/sonyericsson/android/camera/controller/StateMachine;->sendEvent(Lcom/sonyericsson/android/camera/controller/StateMachine$TransitterEvent;[Ljava/lang/Object;)V
...
.method public onSceneModeChanged(Lcom/sonyericsson/android/camera/device/CameraParameters$SceneRecognitionResult;)V
    ...
    iget-object v1, p1, Lcom/sonyericsson/android/camera/device/CameraParameters$SceneRecognitionResult;->deviceStabilityCondition:Lcom/sonyericsson/android/camera/device/CameraParameters$DeviceStabilityCondition;

    # setter for: Lcom/sonyericsson/android/camera/device/CameraDeviceHandler;->mCondition:Lcom/sonyericsson/android/camera/device/CameraParameters$DeviceStabilityCondition;
    invoke-static {v0, v1}, Lcom/sonyericsson/android/camera/device/CameraDeviceHandler;->access$6802(Lcom/sonyericsson/android/camera/device/CameraDeviceHandler;Lcom/sonyericsson/android/camera/device/CameraParameters$DeviceStabilityCondition;)Lcom/sonyericsson/android/camera/device/CameraParameters$DeviceStabilityCondition;
