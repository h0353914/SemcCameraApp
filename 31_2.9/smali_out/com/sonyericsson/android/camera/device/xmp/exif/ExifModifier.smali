...
.method protected constructor <init>(Ljava/nio/ByteBuffer;Lcom/sonyericsson/android/camera/device/xmp/exif/ExifInterface;)V
    ...
    .line 54
    :try_start_15
    new-instance v0, Lcom/sonyericsson/android/camera/device/xmp/exif/ByteBufferInputStream;

    invoke-direct {v0, p1}, Lcom/sonyericsson/android/camera/device/xmp/exif/ByteBufferInputStream;-><init>(Ljava/nio/ByteBuffer;)V
    :try_end_1a
    .catchall {:try_start_15 .. :try_end_1a} :catchall_40

    .line 56
    :try_start_1a
    iget-object p1, p0, Lcom/sonyericsson/android/camera/device/xmp/exif/ExifModifier;->mInterface:Lcom/sonyericsson/android/camera/device/xmp/exif/ExifInterface;

    invoke-static {v0, p1}, Lcom/sonyericsson/android/camera/device/xmp/exif/ExifParser;->parse(Ljava/io/InputStream;Lcom/sonyericsson/android/camera/device/xmp/exif/ExifInterface;)Lcom/sonyericsson/android/camera/device/xmp/exif/ExifParser;

    move-result-object p1

    .line 57
    new-instance p2, Lcom/sonyericsson/android/camera/device/xmp/exif/ExifData;

    invoke-virtual {p1}, Lcom/sonyericsson/android/camera/device/xmp/exif/ExifParser;->getByteOrder()Ljava/nio/ByteOrder;

    move-result-object v1

    invoke-direct {p2, v1}, Lcom/sonyericsson/android/camera/device/xmp/exif/ExifData;-><init>(Ljava/nio/ByteOrder;)V

    iput-object p2, p0, Lcom/sonyericsson/android/camera/device/xmp/exif/ExifModifier;->mTagToModified:Lcom/sonyericsson/android/camera/device/xmp/exif/ExifData;

    .line 58
    iget p2, p0, Lcom/sonyericsson/android/camera/device/xmp/exif/ExifModifier;->mOffsetBase:I

    invoke-virtual {p1}, Lcom/sonyericsson/android/camera/device/xmp/exif/ExifParser;->getTiffStartPosition()I

    move-result p1

    add-int/2addr p2, p1

    iput p2, p0, Lcom/sonyericsson/android/camera/device/xmp/exif/ExifModifier;->mOffsetBase:I
...
.method protected commit()Z
    ...
    .line 98
    :cond_57
    iget-object v7, p0, Lcom/sonyericsson/android/camera/device/xmp/exif/ExifModifier;->mInterface:Lcom/sonyericsson/android/camera/device/xmp/exif/ExifInterface;

    invoke-static {v1, v4, v7}, Lcom/sonyericsson/android/camera/device/xmp/exif/ExifParser;->parse(Ljava/io/InputStream;ILcom/sonyericsson/android/camera/device/xmp/exif/ExifInterface;)Lcom/sonyericsson/android/camera/device/xmp/exif/ExifParser;
    ...
    :try_end_a8
    .catchall {:try_start_9 .. :try_end_a8} :catchall_d9
    ...
    move-result v4
    :try_end_c9
    .catchall {:try_start_ad .. :try_end_c9} :catchall_d9
...
.method protected getByteOrder()Ljava/nio/ByteOrder;
    ...
    .line 66
    iget-object v0, p0, Lcom/sonyericsson/android/camera/device/xmp/exif/ExifModifier;->mTagToModified:Lcom/sonyericsson/android/camera/device/xmp/exif/ExifData;

    invoke-virtual {v0}, Lcom/sonyericsson/android/camera/device/xmp/exif/ExifData;->getByteOrder()Ljava/nio/ByteOrder;
