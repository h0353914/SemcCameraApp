...
.method static synthetic access$000(Lcom/sonyericsson/android/camera/device/zsl/ReprocessDataFactory;Lcom/sonyericsson/android/camera/device/zsl/ReprocessData;)V
    .registers 2
...
.method private dealPreviousImage()V
    ...
    .line 158
    iget-object v1, p0, Lcom/sonyericsson/android/camera/device/zsl/ReprocessDataFactory;->mHandler:Landroid/os/Handler;
...
.method private inputCaptureResult(Landroid/hardware/camera2/TotalCaptureResult;)V
    ...
    const-string p1, "inputCaptureResult X"
...
.method private inputImage(Landroid/media/Image;)V
    ...
    iget-boolean v2, p0, Lcom/sonyericsson/android/camera/device/zsl/ReprocessDataFactory;->mStopped:Z

    if-nez v2, :cond_47

    .line 142
    iget-object v2, p0, Lcom/sonyericsson/android/camera/device/zsl/ReprocessDataFactory;->mDataDeque:Ljava/util/concurrent/LinkedBlockingDeque;
    ...
    .line 148
    iget-object p1, p0, Lcom/sonyericsson/android/camera/device/zsl/ReprocessDataFactory;->mDataDeque:Ljava/util/concurrent/LinkedBlockingDeque;

    invoke-virtual {p1, v1}, Ljava/util/concurrent/LinkedBlockingDeque;->add(Ljava/lang/Object;)Z
...
.method private process(Lcom/sonyericsson/android/camera/device/zsl/ReprocessData;)V
    ...
    .line 78
    :goto_14
    iget-object v0, p0, Lcom/sonyericsson/android/camera/device/zsl/ReprocessDataFactory;->mListener:Lcom/sonyericsson/android/camera/device/zsl/DataListener;

    if-eqz v0, :cond_1c

    .line 79
    invoke-interface {v0, p1}, Lcom/sonyericsson/android/camera/device/zsl/DataListener;->onDataAvailable(Ljava/lang/Object;)V
...
.method public input(Ljava/lang/Object;)V
    ...
    const-string v2, "Unsupported input data type : "
...
.method public start()V
    ...
    sget-object v2, Lcom/sonyericsson/android/camera/device/zsl/ReprocessDataFactory;->TAG:Ljava/lang/String;
    ...
    const-string v2, "reprocess-data-factory"
    ...
    iget-object v2, p0, Lcom/sonyericsson/android/camera/device/zsl/ReprocessDataFactory;->mFactoryThreadHandler:Landroid/os/HandlerThread;

    invoke-virtual {v2}, Landroid/os/HandlerThread;->getLooper()Landroid/os/Looper;

    move-result-object v2

    invoke-direct {v0, p0, v2}, Lcom/sonyericsson/android/camera/device/zsl/ReprocessDataFactory$FactoryHandler;-><init>(Lcom/sonyericsson/android/camera/device/zsl/ReprocessDataFactory;Landroid/os/Looper;)V

    iput-object v0, p0, Lcom/sonyericsson/android/camera/device/zsl/ReprocessDataFactory;->mHandler:Landroid/os/Handler;

    .line 94
    :cond_36
    iput-boolean v1, p0, Lcom/sonyericsson/android/camera/device/zsl/ReprocessDataFactory;->mStopped:Z
