...
.method public constructor <init>(Landroid/content/Context;Lcom/sonyericsson/cameracommon/storage/Storage;)V
    ...
    iput-object p2, p0, Lcom/sonyericsson/android/camera/parameter/UserSettingsLoaderImpl;->mCommonParameters:Lcom/sonyericsson/android/camera/parameter/ModeIndependentParams;

    .line 141
    iget-object p2, p0, Lcom/sonyericsson/android/camera/parameter/UserSettingsLoaderImpl;->mCommonParameters:Lcom/sonyericsson/android/camera/parameter/ModeIndependentParams;
    ...
    invoke-virtual {p2, v0}, Lcom/sonyericsson/android/camera/parameter/ModeIndependentParams;->clear(Lcom/sonyericsson/cameracommon/storage/Storage;)V
...
.method private applyDefaultParameters(Landroid/content/Context;Lcom/sonyericsson/cameracommon/storage/Storage;)V
    ...
    const-string p2, "android.os.Build.FINGERPRINT"

    .line 342
    invoke-virtual {v1, p2, p1, v4}, Lcom/sonyericsson/android/camera/setting/SharedPreferencesAccessor;->writeString(Ljava/lang/String;Ljava/lang/String;Z)V
...
.method private migrateData(Ljava/lang/String;)V
    ...
    invoke-virtual {p1}, Lcom/sonyericsson/android/camera/setting/SharedPreferencesAccessor;->reset()V
...
.method public clearMasterData()V
    ...
    invoke-static {v0, v1}, Lcom/sonyericsson/android/camera/parameter/CameraSettingsMigrator;->getSharedPrefs(Landroid/content/Context;Z)Landroid/content/SharedPreferences;
...
.method public getUserSettingParameters(Landroid/content/Context;Lcom/sonyericsson/android/camera/configuration/parameters/CapturingMode;Lcom/sonyericsson/cameracommon/storage/Storage;Lcom/sonyericsson/android/camera/configuration/Configurations;ZLcom/sonyericsson/android/camera/parameter/ModeIndependentParams;Z)Lcom/sonyericsson/android/camera/parameter/Parameters;
    ...
    .line 199
    :goto_f
    iget-object v4, v1, Lcom/sonyericsson/android/camera/parameter/UserSettingsLoaderImpl;->mParametersEntries:Ljava/util/Map;
    ...
    .line 200
    iget-object v4, v1, Lcom/sonyericsson/android/camera/parameter/UserSettingsLoaderImpl;->mEntryLock:Ljava/lang/Object;

    monitor-enter v4

    .line 202
    :try_start_1a
    iget-object v5, v1, Lcom/sonyericsson/android/camera/parameter/UserSettingsLoaderImpl;->mEntryLock:Ljava/lang/Object;
    ...
    .line 210
    iget-object v5, v1, Lcom/sonyericsson/android/camera/parameter/UserSettingsLoaderImpl;->mParametersEntries:Ljava/util/Map;
    ...
    .line 220
    iget-object v2, v1, Lcom/sonyericsson/android/camera/parameter/UserSettingsLoaderImpl;->mParametersEntries:Ljava/util/Map;
    ...
    .line 222
    iget-object v3, v1, Lcom/sonyericsson/android/camera/parameter/UserSettingsLoaderImpl;->mTempParametersEntries:Ljava/util/Map;
    ...
    invoke-virtual {v2, p4, p3}, Lcom/sonyericsson/android/camera/parameter/Parameters;->copy(Lcom/sonyericsson/android/camera/configuration/Configurations;Lcom/sonyericsson/cameracommon/storage/Storage;)Lcom/sonyericsson/android/camera/parameter/Parameters;
    ...
    .line 225
    :goto_87
    iget-object v2, v1, Lcom/sonyericsson/android/camera/parameter/UserSettingsLoaderImpl;->mTempParametersEntries:Ljava/util/Map;
    ...
    .line 226
    invoke-virtual/range {v2 .. v9}, Lcom/sonyericsson/android/camera/parameter/Parameters;->copy(Landroid/content/Context;Lcom/sonyericsson/android/camera/configuration/parameters/CapturingMode;Lcom/sonyericsson/android/camera/configuration/Configurations;Lcom/sonyericsson/cameracommon/storage/Storage;ZLcom/sonyericsson/android/camera/parameter/ModeIndependentParams;Z)Lcom/sonyericsson/android/camera/parameter/Parameters;
