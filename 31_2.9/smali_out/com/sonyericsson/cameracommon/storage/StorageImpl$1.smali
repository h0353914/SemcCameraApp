...
.method public run()V
    ...
    .line 290
    iget-object v2, p0, Lcom/sonyericsson/cameracommon/storage/StorageImpl$1;->val$uri:Landroid/net/Uri;

    invoke-interface {v0, v2, v1}, Lcom/sonyericsson/cameracommon/storage/Storage$OnLoadCompletedListener;->onLoadCompleted(Landroid/net/Uri;Landroid/graphics/Bitmap;)V
    ...
    invoke-interface {v0, v1, v2}, Lcom/sonyericsson/cameracommon/storage/Storage$OnLoadCompletedListener;->onLoadFailed(Landroid/net/Uri;I)V
