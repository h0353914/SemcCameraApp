...
.method private readImageFileDirectory(Landroidx/exifinterface/media/ExifInterface$ByteOrderedDataInputStream;I)V
    ...
    if-eq v11, v8, :cond_1f0

    const/4 v8, 0x4

    if-eq v11, v8, :cond_1eb

    if-eq v11, v4, :cond_1e6

    const/16 v4, 0x9

    if-eq v11, v4, :cond_1e1
...
.method public setAttribute(Ljava/lang/String;Ljava/lang/String;)V
    ...
    move-result-object v1
    :try_end_a1
    .catch Ljava/lang/NumberFormatException; {:try_start_94 .. :try_end_a1} :catch_a2
    ...
    if-eq v10, v5, :cond_1c9

    iget v10, v8, Landroidx/exifinterface/media/ExifInterface$ExifTag;->primaryFormat:I

    const/4 v11, 0x7

    if-eq v10, v11, :cond_1c9
    ...
    packed-switch v8, :pswitch_data_338
