...
.method static constructor <clinit>()V
    ...
    .line 62
    new-instance v1, Lcom/sonyericsson/android/camera/CameraButtonIntentReceiver$ReceiverState;

    const-string v3, "PREPARE"

    const/4 v4, 0x1

    invoke-direct {v1, v3, v4}, Lcom/sonyericsson/android/camera/CameraButtonIntentReceiver$ReceiverState;-><init>(Ljava/lang/String;I)V

    sput-object v1, Lcom/sonyericsson/android/camera/CameraButtonIntentReceiver$ReceiverState;->PREPARE:Lcom/sonyericsson/android/camera/CameraButtonIntentReceiver$ReceiverState;

    .line 63
    new-instance v3, Lcom/sonyericsson/android/camera/CameraButtonIntentReceiver$ReceiverState;

    const-string v5, "STARTING"

    const/4 v6, 0x2

    invoke-direct {v3, v5, v6}, Lcom/sonyericsson/android/camera/CameraButtonIntentReceiver$ReceiverState;-><init>(Ljava/lang/String;I)V

    sput-object v3, Lcom/sonyericsson/android/camera/CameraButtonIntentReceiver$ReceiverState;->STARTING:Lcom/sonyericsson/android/camera/CameraButtonIntentReceiver$ReceiverState;

    .line 64
    new-instance v5, Lcom/sonyericsson/android/camera/CameraButtonIntentReceiver$ReceiverState;

    const-string v7, "ACTIVE"

    const/4 v8, 0x3

    invoke-direct {v5, v7, v8}, Lcom/sonyericsson/android/camera/CameraButtonIntentReceiver$ReceiverState;-><init>(Ljava/lang/String;I)V

    sput-object v5, Lcom/sonyericsson/android/camera/CameraButtonIntentReceiver$ReceiverState;->ACTIVE:Lcom/sonyericsson/android/camera/CameraButtonIntentReceiver$ReceiverState;

    const/4 v7, 0x4

    new-array v7, v7, [Lcom/sonyericsson/android/camera/CameraButtonIntentReceiver$ReceiverState;
    ...
    .line 60
    sput-object v7, Lcom/sonyericsson/android/camera/CameraButtonIntentReceiver$ReceiverState;->$VALUES:[Lcom/sonyericsson/android/camera/CameraButtonIntentReceiver$ReceiverState;
