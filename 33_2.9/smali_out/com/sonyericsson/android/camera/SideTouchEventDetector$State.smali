...
.method static constructor <clinit>()V
    ...
    .line 167
    new-instance v1, Lcom/sonyericsson/android/camera/SideTouchEventDetector$State;

    const-string v3, "SCROLLING"

    const/4 v4, 0x1

    invoke-direct {v1, v3, v4}, Lcom/sonyericsson/android/camera/SideTouchEventDetector$State;-><init>(Ljava/lang/String;I)V

    sput-object v1, Lcom/sonyericsson/android/camera/SideTouchEventDetector$State;->SCROLLING:Lcom/sonyericsson/android/camera/SideTouchEventDetector$State;

    .line 168
    new-instance v3, Lcom/sonyericsson/android/camera/SideTouchEventDetector$State;

    const-string v5, "DOUBLE_TAPPING"

    const/4 v6, 0x2

    invoke-direct {v3, v5, v6}, Lcom/sonyericsson/android/camera/SideTouchEventDetector$State;-><init>(Ljava/lang/String;I)V

    sput-object v3, Lcom/sonyericsson/android/camera/SideTouchEventDetector$State;->DOUBLE_TAPPING:Lcom/sonyericsson/android/camera/SideTouchEventDetector$State;

    const/4 v5, 0x3

    new-array v5, v5, [Lcom/sonyericsson/android/camera/SideTouchEventDetector$State;
    ...
    .line 165
    sput-object v5, Lcom/sonyericsson/android/camera/SideTouchEventDetector$State;->$VALUES:[Lcom/sonyericsson/android/camera/SideTouchEventDetector$State;
