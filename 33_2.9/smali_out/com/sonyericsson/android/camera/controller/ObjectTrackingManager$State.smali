...
.method static constructor <clinit>()V
    ...
    .line 29
    new-instance v1, Lcom/sonyericsson/android/camera/controller/ObjectTrackingManager$State;

    const-string v3, "IDLE"

    const/4 v4, 0x1

    invoke-direct {v1, v3, v4}, Lcom/sonyericsson/android/camera/controller/ObjectTrackingManager$State;-><init>(Ljava/lang/String;I)V

    sput-object v1, Lcom/sonyericsson/android/camera/controller/ObjectTrackingManager$State;->IDLE:Lcom/sonyericsson/android/camera/controller/ObjectTrackingManager$State;

    .line 30
    new-instance v3, Lcom/sonyericsson/android/camera/controller/ObjectTrackingManager$State;

    const-string v5, "TRACKING"

    const/4 v6, 0x2

    invoke-direct {v3, v5, v6}, Lcom/sonyericsson/android/camera/controller/ObjectTrackingManager$State;-><init>(Ljava/lang/String;I)V

    sput-object v3, Lcom/sonyericsson/android/camera/controller/ObjectTrackingManager$State;->TRACKING:Lcom/sonyericsson/android/camera/controller/ObjectTrackingManager$State;

    .line 31
    new-instance v5, Lcom/sonyericsson/android/camera/controller/ObjectTrackingManager$State;

    const-string v7, "LOST"

    const/4 v8, 0x3

    invoke-direct {v5, v7, v8}, Lcom/sonyericsson/android/camera/controller/ObjectTrackingManager$State;-><init>(Ljava/lang/String;I)V

    sput-object v5, Lcom/sonyericsson/android/camera/controller/ObjectTrackingManager$State;->LOST:Lcom/sonyericsson/android/camera/controller/ObjectTrackingManager$State;

    const/4 v7, 0x4

    new-array v7, v7, [Lcom/sonyericsson/android/camera/controller/ObjectTrackingManager$State;
    ...
    .line 27
    sput-object v7, Lcom/sonyericsson/android/camera/controller/ObjectTrackingManager$State;->$VALUES:[Lcom/sonyericsson/android/camera/controller/ObjectTrackingManager$State;
