...
.method public check(Lcom/sonyericsson/android/camera/device/CaptureResultHolder;)V
    ...
    :try_end_16
    .catch Ljava/lang/IllegalArgumentException; {:try_start_e .. :try_end_16} :catch_18
    ...
    .line 49
    :goto_2d
    iget-boolean v0, p0, Lcom/sonyericsson/android/camera/device/AutoHdrResultChecker;->mIsLastHdrRequired:Z

    if-eq p1, v0, :cond_3d

    .line 50
    iput-boolean p1, p0, Lcom/sonyericsson/android/camera/device/AutoHdrResultChecker;->mIsLastHdrRequired:Z

    .line 51
    iget-object v0, p0, Lcom/sonyericsson/android/camera/device/AutoHdrResultChecker;->mHandler:Landroid/os/Handler;

    new-instance v1, Lcom/sonyericsson/android/camera/device/AutoHdrResultChecker$1;

    invoke-direct {v1, p0, p1}, Lcom/sonyericsson/android/camera/device/AutoHdrResultChecker$1;-><init>(Lcom/sonyericsson/android/camera/device/AutoHdrResultChecker;Z)V
