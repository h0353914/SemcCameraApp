...
.method private checkCaptureDone()V
    ...
    const-string v6, "checkCaptureDone() : mImageReader = "

    invoke-virtual {v5, v6}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v5

    iget-object v6, p0, Lcom/sonyericsson/android/camera/device/CameraController$CaptureRequestCallback;->mImageReader:Landroid/media/ImageReader;

    invoke-virtual {v5, v6}, Ljava/lang/StringBuilder;->append(Ljava/lang/Object;)Ljava/lang/StringBuilder;

    move-result-object v5

    const-string v6, ", mIsCaptureCompleted = "

    invoke-virtual {v5, v6}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v5

    iget-boolean v6, p0, Lcom/sonyericsson/android/camera/device/CameraController$CaptureRequestCallback;->mIsCaptureCompleted:Z

    invoke-virtual {v5, v6}, Ljava/lang/StringBuilder;->append(Z)Ljava/lang/StringBuilder;

    move-result-object v5

    const-string v6, ", mSnapCaptureFrameDropped = "

    invoke-virtual {v5, v6}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v5

    iget-boolean v6, p0, Lcom/sonyericsson/android/camera/device/CameraController$CaptureRequestCallback;->mSnapCaptureFrameDropped:Z
    ...
    .line 2346
    sget-object v9, Lcom/sonyericsson/android/camera/util/PerfLog;->IMAGE_CAPTURED:Lcom/sonyericsson/android/camera/util/PerfLog;

    sub-long/2addr v5, v7

    invoke-virtual {v9, v5, v6}, Lcom/sonyericsson/android/camera/util/PerfLog;->transit(J)V
    ...
    new-instance v5, Lcom/sonyericsson/android/camera/device/CameraController$CaptureRequestCallback$3;

    invoke-direct {v5, p0, v6}, Lcom/sonyericsson/android/camera/device/CameraController$CaptureRequestCallback$3;-><init>(Lcom/sonyericsson/android/camera/device/CameraController$CaptureRequestCallback;[B)V

    invoke-virtual {v0, v5}, Landroid/os/Handler;->post(Ljava/lang/Runnable;)Z
    :try_end_84
    .catch Ljava/lang/RuntimeException; {:try_start_43 .. :try_end_84} :catch_85
    ...
    .line 2369
    iput-boolean v4, p0, Lcom/sonyericsson/android/camera/device/CameraController$CaptureRequestCallback;->mIsCaptureCompleted:Z

    .line 2370
    iput-boolean v4, p0, Lcom/sonyericsson/android/camera/device/CameraController$CaptureRequestCallback;->mSnapCaptureFrameDropped:Z
...
.method public onCaptureProgressed(Landroid/hardware/camera2/CameraCaptureSession;Landroid/hardware/camera2/CaptureRequest;Landroid/hardware/camera2/CaptureResult;)V
    ...
    .line 2280
    :try_start_10
    sget-object v0, Lcom/sonyericsson/android/camera/device/SomcCaptureResultKeys;->SONYMOBILE_CAPTURE_IS_BACKGROUND_TASK:Landroid/hardware/camera2/CaptureResult$Key;
    ...
    invoke-interface {p0, p3}, Lcom/sonyericsson/android/camera/device/CameraController$CameraControllerCallback;->onHalDecideBackgroundTask(Z)V
