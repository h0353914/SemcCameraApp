...
.method private createPreviewSessionAfterCameraOpened()V
    ...
    const-string v2, " is removed, it need not createPreviewSession."
...
.method public doCameraDeviceAccess()V
    ...
    invoke-virtual {v2, v0}, Lcom/sonyericsson/android/camera/device/CameraController;->getTargetDeviceID(Lcom/sonyericsson/android/camera/device/CameraParameters;)Ljava/lang/String;
    ...
    :try_end_b8
    .catch Ljava/lang/SecurityException; {:try_start_70 .. :try_end_b8} :catch_244
    .catch Landroid/hardware/camera2/CameraAccessException; {:try_start_70 .. :try_end_b8} :catch_244
    .catch Ljava/lang/IllegalArgumentException; {:try_start_70 .. :try_end_b8} :catch_244
    ...
    .line 2761
    invoke-virtual {v2, v4, v6}, Lcom/sonyericsson/android/camera/device/CaptureRequestHolder;->set(Landroid/hardware/camera2/CaptureRequest$Key;Ljava/lang/Object;)V
    ...
    monitor-exit v2
    :try_end_1c5
    .catchall {:try_start_1be .. :try_end_1c5} :catchall_1c3
    ...
    invoke-virtual {v4, p0}, Lcom/sonyericsson/android/camera/device/CameraDeviceHandler$CameraDeviceHandlerInquirer;->getParameters(Lcom/sonyericsson/android/camera/device/CameraDeviceHandler$CameraSessionId;)Lcom/sonyericsson/android/camera/device/CameraParameters;
    ...
    invoke-direct {v4, v2, v5}, Lcom/sonyericsson/cameracommon/status/EachCameraStatusPublisher;-><init>(Landroid/content/Context;Lcom/sonyericsson/android/camera/device/CameraInfo$CameraId;)V
    ...
    sget-object v6, Lcom/sonyericsson/android/camera/configuration/parameters/VideoHdr;->HDR_OFF:Lcom/sonyericsson/android/camera/configuration/parameters/VideoHdr;

    .line 2864
    invoke-static {p0, v6}, Lcom/sonyericsson/android/camera/recorder/RecordingProfile;->getVideoFrameRate(Lcom/sonyericsson/android/camera/configuration/parameters/VideoSize;Lcom/sonyericsson/android/camera/configuration/parameters/VideoHdr;)I

    move-result p0

    invoke-direct {v5, p0}, Lcom/sonyericsson/cameracommon/status/eachcamera/VideoRecordingFps;-><init>(I)V
    ...
    invoke-direct {p0, v2}, Lcom/sonyericsson/cameracommon/status/GlobalCameraStatusPublisher;-><init>(Landroid/content/Context;)V
    ...
    invoke-virtual {p0, v2}, Lcom/sonyericsson/cameracommon/status/GlobalCameraStatusPublisher;->put(Lcom/sonyericsson/cameracommon/status/CameraStatusValue;)Lcom/sonyericsson/cameracommon/status/CameraStatusPublisher;
