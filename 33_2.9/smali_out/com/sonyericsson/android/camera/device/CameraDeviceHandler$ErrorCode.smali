...
.method static constructor <clinit>()V
    ...
    .line 4856
    new-instance v1, Lcom/sonyericsson/android/camera/device/CameraDeviceHandler$ErrorCode;

    const-string v3, "ERROR_ON_CAMERA_DISCONNECTION"

    const/4 v4, 0x1

    invoke-direct {v1, v3, v4}, Lcom/sonyericsson/android/camera/device/CameraDeviceHandler$ErrorCode;-><init>(Ljava/lang/String;I)V

    sput-object v1, Lcom/sonyericsson/android/camera/device/CameraDeviceHandler$ErrorCode;->ERROR_ON_CAMERA_DISCONNECTION:Lcom/sonyericsson/android/camera/device/CameraDeviceHandler$ErrorCode;

    .line 4857
    new-instance v3, Lcom/sonyericsson/android/camera/device/CameraDeviceHandler$ErrorCode;

    const-string v5, "ERROR_ON_CAPTURE_FAILED"

    const/4 v6, 0x2

    invoke-direct {v3, v5, v6}, Lcom/sonyericsson/android/camera/device/CameraDeviceHandler$ErrorCode;-><init>(Ljava/lang/String;I)V

    sput-object v3, Lcom/sonyericsson/android/camera/device/CameraDeviceHandler$ErrorCode;->ERROR_ON_CAPTURE_FAILED:Lcom/sonyericsson/android/camera/device/CameraDeviceHandler$ErrorCode;

    .line 4858
    new-instance v5, Lcom/sonyericsson/android/camera/device/CameraDeviceHandler$ErrorCode;

    const-string v7, "ERROR_ON_CONFIGURE_FAILED"

    const/4 v8, 0x3

    invoke-direct {v5, v7, v8}, Lcom/sonyericsson/android/camera/device/CameraDeviceHandler$ErrorCode;-><init>(Ljava/lang/String;I)V

    sput-object v5, Lcom/sonyericsson/android/camera/device/CameraDeviceHandler$ErrorCode;->ERROR_ON_CONFIGURE_FAILED:Lcom/sonyericsson/android/camera/device/CameraDeviceHandler$ErrorCode;

    .line 4859
    new-instance v7, Lcom/sonyericsson/android/camera/device/CameraDeviceHandler$ErrorCode;

    const-string v9, "ERROR_ON_CREATE_PERSIST_SURFACE"

    const/4 v10, 0x4

    invoke-direct {v7, v9, v10}, Lcom/sonyericsson/android/camera/device/CameraDeviceHandler$ErrorCode;-><init>(Ljava/lang/String;I)V

    sput-object v7, Lcom/sonyericsson/android/camera/device/CameraDeviceHandler$ErrorCode;->ERROR_ON_CREATE_PERSIST_SURFACE:Lcom/sonyericsson/android/camera/device/CameraDeviceHandler$ErrorCode;

    const/4 v9, 0x5

    new-array v9, v9, [Lcom/sonyericsson/android/camera/device/CameraDeviceHandler$ErrorCode;
    ...
    .line 4854
    sput-object v9, Lcom/sonyericsson/android/camera/device/CameraDeviceHandler$ErrorCode;->$VALUES:[Lcom/sonyericsson/android/camera/device/CameraDeviceHandler$ErrorCode;
