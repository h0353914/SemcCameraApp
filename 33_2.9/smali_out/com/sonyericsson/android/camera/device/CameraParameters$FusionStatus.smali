...
.method static constructor <clinit>()V
    ...
    .line 1001
    new-instance v1, Lcom/sonyericsson/android/camera/device/CameraParameters$FusionStatus;

    const-string v3, "MAIN"

    const/4 v4, 0x1

    invoke-direct {v1, v3, v4}, Lcom/sonyericsson/android/camera/device/CameraParameters$FusionStatus;-><init>(Ljava/lang/String;I)V

    sput-object v1, Lcom/sonyericsson/android/camera/device/CameraParameters$FusionStatus;->MAIN:Lcom/sonyericsson/android/camera/device/CameraParameters$FusionStatus;

    .line 1002
    new-instance v3, Lcom/sonyericsson/android/camera/device/CameraParameters$FusionStatus;

    const-string v5, "SUB_1"

    const/4 v6, 0x2

    invoke-direct {v3, v5, v6}, Lcom/sonyericsson/android/camera/device/CameraParameters$FusionStatus;-><init>(Ljava/lang/String;I)V

    sput-object v3, Lcom/sonyericsson/android/camera/device/CameraParameters$FusionStatus;->SUB_1:Lcom/sonyericsson/android/camera/device/CameraParameters$FusionStatus;

    .line 1003
    new-instance v5, Lcom/sonyericsson/android/camera/device/CameraParameters$FusionStatus;

    const-string v7, "FUSION_MAIN"

    const/4 v8, 0x3

    invoke-direct {v5, v7, v8}, Lcom/sonyericsson/android/camera/device/CameraParameters$FusionStatus;-><init>(Ljava/lang/String;I)V

    sput-object v5, Lcom/sonyericsson/android/camera/device/CameraParameters$FusionStatus;->FUSION_MAIN:Lcom/sonyericsson/android/camera/device/CameraParameters$FusionStatus;

    .line 1004
    new-instance v7, Lcom/sonyericsson/android/camera/device/CameraParameters$FusionStatus;

    const-string v9, "FUSION_SUB_1"

    const/4 v10, 0x4

    invoke-direct {v7, v9, v10}, Lcom/sonyericsson/android/camera/device/CameraParameters$FusionStatus;-><init>(Ljava/lang/String;I)V

    sput-object v7, Lcom/sonyericsson/android/camera/device/CameraParameters$FusionStatus;->FUSION_SUB_1:Lcom/sonyericsson/android/camera/device/CameraParameters$FusionStatus;

    const/4 v9, 0x5

    new-array v9, v9, [Lcom/sonyericsson/android/camera/device/CameraParameters$FusionStatus;
    ...
    .line 999
    sput-object v9, Lcom/sonyericsson/android/camera/device/CameraParameters$FusionStatus;->$VALUES:[Lcom/sonyericsson/android/camera/device/CameraParameters$FusionStatus;
