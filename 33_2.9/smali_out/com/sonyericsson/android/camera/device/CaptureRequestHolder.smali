...
.method private setRequest(Landroid/hardware/camera2/CaptureRequest$Builder;Landroid/hardware/camera2/CaptureRequest$Key;Ljava/util/Map;)V
    ...
    const-string v0, "setRequest(): key ("
...
.method varargs declared-synchronized createCaptureRequest(Landroid/hardware/camera2/CameraDevice;ILjava/lang/Object;Z[Landroid/view/Surface;)Landroid/hardware/camera2/CaptureRequest;
    ...
    .catch Ljava/lang/IllegalStateException; {:try_start_e .. :try_end_47} :catch_5a
...
.method varargs declared-synchronized createHighSpeedRequestList(Landroid/hardware/camera2/CameraDevice;Landroid/hardware/camera2/CameraConstrainedHighSpeedCaptureSession;I[Landroid/view/Surface;)Ljava/util/List;
    ...
    .catch Ljava/lang/IllegalArgumentException; {:try_start_e .. :try_end_40} :catch_4f
...
.method declared-synchronized get(Landroid/hardware/camera2/CaptureRequest$Key;)Ljava/lang/Object;
    ...
    :try_end_3e
    .catchall {:try_start_a .. :try_end_3e} :catchall_49
    ...
    :try_end_47
    .catchall {:try_start_3e .. :try_end_47} :catchall_54
...
.method declared-synchronized set(Landroid/hardware/camera2/CaptureRequest$Key;Ljava/lang/Object;)V
    ...
    invoke-interface {v0}, Ljava/util/concurrent/locks/Lock;->lock()V
    :try_end_a
    .catchall {:try_start_1 .. :try_end_a} :catchall_53
    ...
    invoke-static {v0}, Lcom/sonyericsson/android/camera/util/CamLog;->d([Ljava/lang/String;)V
    :try_end_46
    .catchall {:try_start_f .. :try_end_46} :catchall_53
...
.method setDefault(Lcom/sonyericsson/android/camera/device/CameraInfo$CameraId;)V
    ...
    invoke-virtual {p0, v1, v5}, Lcom/sonyericsson/android/camera/device/CaptureRequestHolder;->set(Landroid/hardware/camera2/CaptureRequest$Key;Ljava/lang/Object;)V
    ...
    invoke-virtual {p0, v0, v3}, Lcom/sonyericsson/android/camera/device/CaptureRequestHolder;->set(Landroid/hardware/camera2/CaptureRequest$Key;Ljava/lang/Object;)V
    ...
    invoke-virtual {p0, v0, v8}, Lcom/sonyericsson/android/camera/device/CaptureRequestHolder;->set(Landroid/hardware/camera2/CaptureRequest$Key;Ljava/lang/Object;)V
    ...
    invoke-virtual {p0, p1, v3}, Lcom/sonyericsson/android/camera/device/CaptureRequestHolder;->set(Landroid/hardware/camera2/CaptureRequest$Key;Ljava/lang/Object;)V
