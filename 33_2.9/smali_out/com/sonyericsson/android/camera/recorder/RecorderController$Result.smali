...
.method static constructor <clinit>()V
    ...
    .line 34
    new-instance v1, Lcom/sonyericsson/android/camera/recorder/RecorderController$Result;

    const-string v3, "FAIL"

    const/4 v4, 0x1

    invoke-direct {v1, v3, v4}, Lcom/sonyericsson/android/camera/recorder/RecorderController$Result;-><init>(Ljava/lang/String;I)V

    sput-object v1, Lcom/sonyericsson/android/camera/recorder/RecorderController$Result;->FAIL:Lcom/sonyericsson/android/camera/recorder/RecorderController$Result;

    .line 35
    new-instance v3, Lcom/sonyericsson/android/camera/recorder/RecorderController$Result;

    const-string v5, "MAX_DURATION_REACHED"

    const/4 v6, 0x2

    invoke-direct {v3, v5, v6}, Lcom/sonyericsson/android/camera/recorder/RecorderController$Result;-><init>(Ljava/lang/String;I)V

    sput-object v3, Lcom/sonyericsson/android/camera/recorder/RecorderController$Result;->MAX_DURATION_REACHED:Lcom/sonyericsson/android/camera/recorder/RecorderController$Result;

    .line 36
    new-instance v5, Lcom/sonyericsson/android/camera/recorder/RecorderController$Result;

    const-string v7, "MAX_FILESIZE_REACHED"

    const/4 v8, 0x3

    invoke-direct {v5, v7, v8}, Lcom/sonyericsson/android/camera/recorder/RecorderController$Result;-><init>(Ljava/lang/String;I)V

    sput-object v5, Lcom/sonyericsson/android/camera/recorder/RecorderController$Result;->MAX_FILESIZE_REACHED:Lcom/sonyericsson/android/camera/recorder/RecorderController$Result;

    const/4 v7, 0x4

    new-array v7, v7, [Lcom/sonyericsson/android/camera/recorder/RecorderController$Result;
    ...
    .line 32
    sput-object v7, Lcom/sonyericsson/android/camera/recorder/RecorderController$Result;->$VALUES:[Lcom/sonyericsson/android/camera/recorder/RecorderController$Result;
