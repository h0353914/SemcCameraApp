...
.method public getLatestZoomStep(Lcom/sonyericsson/android/camera/configuration/parameters/CapturingMode;)I
    ...
    invoke-virtual {p0, v1, v0}, Lcom/sonyericsson/android/camera/setting/SharedPreferencesAccessor;->remove(Ljava/lang/String;Z)V
...
.method public writePauseTime()V
    ...
    const-string v2, "KEY_TIME_APP_PAUSED"

    const/4 v3, 0x0

    .line 79
    invoke-virtual {p0, v2, v0, v1, v3}, Lcom/sonyericsson/android/camera/setting/SharedPreferencesAccessor;->writeLong(Ljava/lang/String;JZ)V
