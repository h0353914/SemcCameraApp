...
.field public static final enum PERMISSION_DENIED:Lcom/sonyericsson/android/camera/util/capability/PlatformCapability$PrepareState;
...
.method static constructor <clinit>()V
    ...
    .line 187
    new-instance v1, Lcom/sonyericsson/android/camera/util/capability/PlatformCapability$PrepareState;

    const-string v3, "RUNNING"

    const/4 v4, 0x1

    invoke-direct {v1, v3, v4}, Lcom/sonyericsson/android/camera/util/capability/PlatformCapability$PrepareState;-><init>(Ljava/lang/String;I)V

    sput-object v1, Lcom/sonyericsson/android/camera/util/capability/PlatformCapability$PrepareState;->RUNNING:Lcom/sonyericsson/android/camera/util/capability/PlatformCapability$PrepareState;

    .line 192
    new-instance v3, Lcom/sonyericsson/android/camera/util/capability/PlatformCapability$PrepareState;

    const-string v5, "TIMED_OUT"

    const/4 v6, 0x2

    invoke-direct {v3, v5, v6}, Lcom/sonyericsson/android/camera/util/capability/PlatformCapability$PrepareState;-><init>(Ljava/lang/String;I)V

    sput-object v3, Lcom/sonyericsson/android/camera/util/capability/PlatformCapability$PrepareState;->TIMED_OUT:Lcom/sonyericsson/android/camera/util/capability/PlatformCapability$PrepareState;

    .line 197
    new-instance v5, Lcom/sonyericsson/android/camera/util/capability/PlatformCapability$PrepareState;

    const-string v7, "PERMISSION_DENIED"

    const/4 v8, 0x3

    invoke-direct {v5, v7, v8}, Lcom/sonyericsson/android/camera/util/capability/PlatformCapability$PrepareState;-><init>(Ljava/lang/String;I)V

    sput-object v5, Lcom/sonyericsson/android/camera/util/capability/PlatformCapability$PrepareState;->PERMISSION_DENIED:Lcom/sonyericsson/android/camera/util/capability/PlatformCapability$PrepareState;

    const/4 v7, 0x4

    new-array v7, v7, [Lcom/sonyericsson/android/camera/util/capability/PlatformCapability$PrepareState;
    ...
    .line 176
    sput-object v7, Lcom/sonyericsson/android/camera/util/capability/PlatformCapability$PrepareState;->$VALUES:[Lcom/sonyericsson/android/camera/util/capability/PlatformCapability$PrepareState;
