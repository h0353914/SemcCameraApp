...
.method static constructor <clinit>()V
    ...
    .line 794
    new-instance v1, Lcom/sonyericsson/android/camera/view/UserEventHandler$ActionByKey;

    const-string v3, "REJECT"

    const/4 v4, 0x1

    invoke-direct {v1, v3, v4}, Lcom/sonyericsson/android/camera/view/UserEventHandler$ActionByKey;-><init>(Ljava/lang/String;I)V

    sput-object v1, Lcom/sonyericsson/android/camera/view/UserEventHandler$ActionByKey;->REJECT:Lcom/sonyericsson/android/camera/view/UserEventHandler$ActionByKey;

    .line 797
    new-instance v3, Lcom/sonyericsson/android/camera/view/UserEventHandler$ActionByKey;

    const-string v5, "CAPTURE"

    const/4 v6, 0x2

    invoke-direct {v3, v5, v6}, Lcom/sonyericsson/android/camera/view/UserEventHandler$ActionByKey;-><init>(Ljava/lang/String;I)V

    sput-object v3, Lcom/sonyericsson/android/camera/view/UserEventHandler$ActionByKey;->CAPTURE:Lcom/sonyericsson/android/camera/view/UserEventHandler$ActionByKey;

    .line 800
    new-instance v5, Lcom/sonyericsson/android/camera/view/UserEventHandler$ActionByKey;

    const-string v7, "CAPTURE_BURST"

    const/4 v8, 0x3

    invoke-direct {v5, v7, v8}, Lcom/sonyericsson/android/camera/view/UserEventHandler$ActionByKey;-><init>(Ljava/lang/String;I)V

    sput-object v5, Lcom/sonyericsson/android/camera/view/UserEventHandler$ActionByKey;->CAPTURE_BURST:Lcom/sonyericsson/android/camera/view/UserEventHandler$ActionByKey;

    .line 803
    new-instance v7, Lcom/sonyericsson/android/camera/view/UserEventHandler$ActionByKey;

    const-string v9, "NONE"

    const/4 v10, 0x4

    invoke-direct {v7, v9, v10}, Lcom/sonyericsson/android/camera/view/UserEventHandler$ActionByKey;-><init>(Ljava/lang/String;I)V

    sput-object v7, Lcom/sonyericsson/android/camera/view/UserEventHandler$ActionByKey;->NONE:Lcom/sonyericsson/android/camera/view/UserEventHandler$ActionByKey;

    const/4 v9, 0x5

    new-array v9, v9, [Lcom/sonyericsson/android/camera/view/UserEventHandler$ActionByKey;
    ...
    .line 789
    sput-object v9, Lcom/sonyericsson/android/camera/view/UserEventHandler$ActionByKey;->$VALUES:[Lcom/sonyericsson/android/camera/view/UserEventHandler$ActionByKey;
