...
.method private static createInsertOperation(Lcom/sonyericsson/android/camera/view/modeselector/CapturingModeAttributes;I)Landroid/content/ContentProviderOperation;
    ...
    const-string/jumbo v1, "visibility_normal"
    ...
    const-string/jumbo v1, "visibility_oneshot"
    ...
    const-string/jumbo v1, "visibility_shortcut"
    ...
    const-string v1, "shortcuticon_id"
...
.method private static createUpdateSortOrderOperation(Lcom/sonyericsson/android/camera/view/modeselector/CapturingModeAttributes;I)Landroid/content/ContentProviderOperation;
    ...
    invoke-virtual {p0, v0, v2}, Landroid/content/ContentProviderOperation$Builder;->withSelection(Ljava/lang/String;[Ljava/lang/String;)Landroid/content/ContentProviderOperation$Builder;
...
.method private saveCapturingModeSortedList(Ljava/util/List;)V
    ...
    const-string v5, "saveCapturingModeList size:"
    ...
    .line 359
    invoke-virtual {v5}, Lcom/sonyericsson/android/camera/view/modeselector/CapturingModeAttributes;->getId()Ljava/lang/Long;
    ...
    .line 362
    invoke-static {v5, v4}, Lcom/sonyericsson/android/camera/view/modeselector/CapturingModeCollection;->createUpdateSortOrderOperation(Lcom/sonyericsson/android/camera/view/modeselector/CapturingModeAttributes;I)Landroid/content/ContentProviderOperation;
    ...
    .line 366
    :cond_46
    invoke-static {v5, v4}, Lcom/sonyericsson/android/camera/view/modeselector/CapturingModeCollection;->createInsertOperation(Lcom/sonyericsson/android/camera/view/modeselector/CapturingModeAttributes;I)Landroid/content/ContentProviderOperation;
    ...
    :try_end_57
    .catch Landroid/os/RemoteException; {:try_start_50 .. :try_end_57} :catch_94
    .catch Landroid/content/OperationApplicationException; {:try_start_50 .. :try_end_57} :catch_76
...
.method private unregisterCapturingModes(Ljava/util/List;)V
    ...
    const-string v3, "com.sonymobile.camerauicommon.provider"

    invoke-virtual {p0, v3, v1}, Landroid/content/ContentResolver;->applyBatch(Ljava/lang/String;Ljava/util/ArrayList;)[Landroid/content/ContentProviderResult;
    :try_end_3d
    .catch Landroid/os/RemoteException; {:try_start_36 .. :try_end_3d} :catch_5c
    .catch Landroid/content/OperationApplicationException; {:try_start_36 .. :try_end_3d} :catch_3e
...
.method public getCapturingModeList([Lcom/sonyericsson/android/camera/view/modeselector/CapturingModeAttributes$InternalCaptureType;[Lcom/sonyericsson/android/camera/view/modeselector/CapturingModeAttributes$VisibilityType;)Ljava/util/List;
    ...
    :try_end_b2
    .catchall {:try_start_a5 .. :try_end_b2} :catchall_b7
