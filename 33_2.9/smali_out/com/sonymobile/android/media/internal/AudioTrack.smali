...
.method protected doPrepare()V
    ...
    :try_end_5e
    .catch Ljava/lang/IllegalArgumentException; {:try_start_44 .. :try_end_5e} :catch_bd
    ...
    const-string v10, "Unable to create encoder"

    if-eqz v4, :cond_82

    :try_start_6a
    const-string v4, "OMX.qcom.audio.encoder.aac"
    ...
    iput-object v4, v1, Lcom/sonymobile/android/media/internal/AudioTrack;->mEncoder:Landroid/media/MediaCodec;
    :try_end_72
    .catch Ljava/io/IOException; {:try_start_6a .. :try_end_72} :catch_74
    .catch Ljava/lang/NullPointerException; {:try_start_6a .. :try_end_72} :catch_74
    .catch Ljava/lang/IllegalArgumentException; {:try_start_6a .. :try_end_72} :catch_82
    ...
    :try_end_97
    .catch Ljava/io/IOException; {:try_start_91 .. :try_end_97} :catch_af
    .catch Ljava/lang/NullPointerException; {:try_start_91 .. :try_end_97} :catch_af
    ...
    invoke-direct {v2, v1, v4}, Lcom/sonymobile/android/media/internal/AudioTrack$AudioEncoderCallback;-><init>(Lcom/sonymobile/android/media/internal/AudioTrack;Lcom/sonymobile/android/media/internal/AudioTrack$1;)V
