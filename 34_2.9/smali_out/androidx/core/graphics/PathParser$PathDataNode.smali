...
.method private static addCommand(Landroid/graphics/Path;[FCC[F)V
    ...
    sparse-switch v11, :sswitch_data_2e8
    ...
    if-ge v7, v1, :cond_2d6

    const/16 v1, 0x41

    if-eq v11, v1, :cond_292
    ...
    if-eq v11, v5, :cond_25d

    const/16 v5, 0x51

    if-eq v11, v5, :cond_23e

    const/16 v6, 0x56

    if-eq v11, v6, :cond_232

    const/16 v6, 0x61

    if-eq v11, v6, :cond_1e7

    const/16 v6, 0x63

    if-eq v11, v6, :cond_1bc

    const/16 v15, 0x68

    if-eq v11, v15, :cond_1b1

    const/16 v15, 0x71

    if-eq v11, v15, :cond_194

    const/16 v14, 0x76

    if-eq v11, v14, :cond_18a

    const/16 v14, 0x4c

    if-eq v11, v14, :cond_17b

    const/16 v14, 0x4d

    if-eq v11, v14, :cond_163
    ...
    if-eq v11, v1, :cond_fe

    const/16 v1, 0x6d

    if-eq v11, v1, :cond_eb
