...
.method varargs declared-synchronized createCaptureRequest(Landroid/hardware/camera2/CameraDevice;ILjava/lang/Object;Z[Landroid/view/Surface;)Landroid/hardware/camera2/CaptureRequest;
    ...
    :try_end_48
    .catch Landroid/hardware/camera2/CameraAccessException; {:try_start_10 .. :try_end_48} :catch_5b
    .catch Ljava/lang/IllegalStateException; {:try_start_10 .. :try_end_48} :catch_5b
    .catchall {:try_start_10 .. :try_end_48} :catchall_64
...
.method varargs declared-synchronized createCaptureRequestForNightPortraitSpecialFrame(Landroid/hardware/camera2/CameraDevice;ILjava/lang/Object;I[Landroid/view/Surface;)Landroid/hardware/camera2/CaptureRequest;
    ...
    invoke-virtual {p1, p2, p3}, Landroid/hardware/camera2/CaptureRequest$Builder;->set(Landroid/hardware/camera2/CaptureRequest$Key;Ljava/lang/Object;)V
    :try_end_58
    .catch Landroid/hardware/camera2/CameraAccessException; {:try_start_10 .. :try_end_58} :catch_6b
    .catchall {:try_start_10 .. :try_end_58} :catchall_74
    ...
    invoke-static {p2, p1}, Lcom/sonyericsson/android/camera/util/CamLog;->e(Ljava/lang/String;Ljava/lang/Throwable;)V
    :try_end_71
    .catchall {:try_start_6c .. :try_end_71} :catchall_74
...
.method varargs declared-synchronized createCaptureRequestList(Landroid/hardware/camera2/CameraDevice;Ljava/util/Map;ILjava/lang/Object;IZ[Landroid/view/Surface;)Ljava/util/List;
    ...
    invoke-static {v0}, Lcom/sonyericsson/android/camera/util/CamLog;->d([Ljava/lang/String;)V
    :try_end_10
    .catchall {:try_start_1 .. :try_end_10} :catchall_a0
    ...
    :try_end_85
    .catch Landroid/hardware/camera2/CameraAccessException; {:try_start_10 .. :try_end_85} :catch_97
    .catchall {:try_start_10 .. :try_end_85} :catchall_a0
    ...
    :try_end_95
    .catchall {:try_start_88 .. :try_end_95} :catchall_a0
...
.method varargs declared-synchronized createHighSpeedRequestList(Landroid/hardware/camera2/CameraDevice;Landroid/hardware/camera2/CameraConstrainedHighSpeedCaptureSession;I[Landroid/view/Surface;)Ljava/util/List;
    ...
    move-result-object p1
    :try_end_42
    .catch Landroid/hardware/camera2/CameraAccessException; {:try_start_10 .. :try_end_42} :catch_51
    .catch Ljava/lang/IllegalArgumentException; {:try_start_10 .. :try_end_42} :catch_51
    .catchall {:try_start_10 .. :try_end_42} :catchall_5a
    ...
    invoke-static {p2}, Lcom/sonyericsson/android/camera/util/CamLog;->d([Ljava/lang/String;)V
    :try_end_4f
    .catchall {:try_start_42 .. :try_end_4f} :catchall_5a
    ...
    invoke-static {p2, p1}, Lcom/sonyericsson/android/camera/util/CamLog;->e(Ljava/lang/String;Ljava/lang/Throwable;)V
    :try_end_57
    .catchall {:try_start_52 .. :try_end_57} :catchall_5a
...
.method declared-synchronized get(Landroid/hardware/camera2/CaptureRequest$Key;)Ljava/lang/Object;
    ...
    :try_end_3a
    .catchall {:try_start_c .. :try_end_3a} :catchall_45
...
.method declared-synchronized set(Landroid/hardware/camera2/CaptureRequest$Key;Ljava/lang/Object;)V
    ...
    invoke-static {v1}, Lcom/sonyericsson/android/camera/util/CamLog;->d([Ljava/lang/String;)V
    :try_end_42
    .catchall {:try_start_11 .. :try_end_42} :catchall_4f
