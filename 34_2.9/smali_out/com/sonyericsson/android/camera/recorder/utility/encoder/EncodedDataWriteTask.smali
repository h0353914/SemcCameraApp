...
.method private awaitEncoderFormat()Z
    ...
    iget-object v1, p0, Lcom/sonyericsson/android/camera/recorder/utility/encoder/EncodedDataWriteTask;->mName:Ljava/lang/String;
    ...
    .line 154
    iget-object v1, p0, Lcom/sonyericsson/android/camera/recorder/utility/encoder/EncodedDataWriteTask;->mCodec:Landroid/media/MediaCodec;
    ...
    iget-object p0, p0, Lcom/sonyericsson/android/camera/recorder/utility/encoder/EncodedDataWriteTask;->mName:Ljava/lang/String;
...
.method public run()V
    ...
    iget-object v7, p0, Lcom/sonyericsson/android/camera/recorder/utility/encoder/EncodedDataWriteTask;->mName:Ljava/lang/String;
    ...
    monitor-exit v3
    :try_end_7a
    .catchall {:try_start_1b .. :try_end_7a} :catchall_1f4
    ...
    move-result v2
    :try_end_90
    .catch Ljava/lang/IllegalStateException; {:try_start_87 .. :try_end_90} :catch_1d5
    ...
    iget-object v5, p0, Lcom/sonyericsson/android/camera/recorder/utility/encoder/EncodedDataWriteTask;->mName:Ljava/lang/String;
    ...
    .line 116
    :cond_124
    iget-object v5, p0, Lcom/sonyericsson/android/camera/recorder/utility/encoder/EncodedDataWriteTask;->mMuxer:Lcom/sonyericsson/android/camera/recorder/utility/encoder/MediaMuxerWrapper;
    ...
    iget v8, p0, Lcom/sonyericsson/android/camera/recorder/utility/encoder/EncodedDataWriteTask;->mMuxerIndex:I

    invoke-virtual {v7, v8, v3, v1}, Lcom/sonyericsson/android/camera/recorder/utility/encoder/MediaMuxerWrapper;->writeSampleData(ILjava/nio/ByteBuffer;Landroid/media/MediaCodec$BufferInfo;)V

    .line 118
    monitor-exit v5
    :try_end_12f
    .catchall {:try_start_127 .. :try_end_12f} :catchall_182
    ...
    :cond_1ec
    :goto_1ec
    iget-object p0, p0, Lcom/sonyericsson/android/camera/recorder/utility/encoder/EncodedDataWriteTask;->mListener:Lcom/sonyericsson/android/camera/recorder/utility/encoder/EncodedDataWriteTask$EncoderStateListener;

    if-eqz p0, :cond_1f3

    .line 145
    invoke-interface {p0}, Lcom/sonyericsson/android/camera/recorder/utility/encoder/EncodedDataWriteTask$EncoderStateListener;->onEncoderFinished()V
