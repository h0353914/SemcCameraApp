.class public Lcom/sonyericsson/android/camera/util/capability/NormalSlowMotionVideoConfigurationListCapabilityItem;
.super Lcom/sonyericsson/android/camera/util/capability/CapabilityItem;
.source "NormalSlowMotionVideoConfigurationListCapabilityItem.java"
...
.method bridge synthetic getDefaultValue()Ljava/lang/Object;
    ...
    .line 18
    invoke-virtual {p0}, Lcom/sonyericsson/android/camera/util/capability/NormalSlowMotionVideoConfigurationListCapabilityItem;->getDefaultValue()Ljava/util/List;
...
.method public bridge synthetic read(Landroid/content/SharedPreferences;Ljava/lang/String;)Ljava/lang/Object;
    ...
    .line 18
    invoke-virtual {p0, p1, p2}, Lcom/sonyericsson/android/camera/util/capability/NormalSlowMotionVideoConfigurationListCapabilityItem;->read(Landroid/content/SharedPreferences;Ljava/lang/String;)Ljava/util/List;
...
.method public read(Landroid/content/SharedPreferences;Ljava/lang/String;)Ljava/util/List;
    ...
    .line 33
    invoke-static {p0}, Lcom/sonyericsson/android/camera/util/capability/SharedPrefsTranslator;->getSlowMotionConfigurationList(Ljava/lang/String;)Ljava/util/List;
...
.method public write(Landroid/content/SharedPreferences$Editor;)V
    ...
    .line 40
    invoke-virtual {p0}, Lcom/sonyericsson/android/camera/util/capability/NormalSlowMotionVideoConfigurationListCapabilityItem;->get()Ljava/lang/Object;
    ...
    .line 42
    invoke-virtual {p0}, Lcom/sonyericsson/android/camera/util/capability/NormalSlowMotionVideoConfigurationListCapabilityItem;->getName()Ljava/lang/String;

    move-result-object p0

    invoke-static {v0}, Lcom/sonyericsson/android/camera/util/capability/SharedPrefsTranslator;->fromSlowMotionConfigurationList(Ljava/util/List;)Ljava/lang/String;
