...
.method private getPluginsFromPackageManager()V
    ...
    :try_end_a2
    .catch Landroid/content/pm/PackageManager$NameNotFoundException; {:try_start_89 .. :try_end_a2} :catch_142
    ...
    :try_end_b5
    .catch Landroid/content/pm/PackageManager$NameNotFoundException; {:try_start_ad .. :try_end_b5} :catch_11f
    ...
    :try_end_e5
    .catch Lorg/xmlpull/v1/XmlPullParserException; {:try_start_b5 .. :try_end_e5} :catch_f1
    .catch Ljava/io/IOException; {:try_start_b5 .. :try_end_e5} :catch_e7
...
.method private parseModeAttributesFromMetaData(Landroid/content/pm/ResolveInfo;Landroid/content/pm/ActivityInfo;Landroid/content/res/Resources;)Z
    ...
    :try_end_31
    .catch Lorg/xmlpull/v1/XmlPullParserException; {:try_start_2d .. :try_end_31} :catch_c2
    .catch Ljava/io/IOException; {:try_start_2d .. :try_end_31} :catch_c2
    ...
    invoke-static {p0}, Lcom/sonyericsson/android/camera/util/CamLog;->e([Ljava/lang/String;)V
    :try_end_3c
    .catchall {:try_start_33 .. :try_end_3c} :catchall_b6
    ...
    :try_end_41
    .catch Lorg/xmlpull/v1/XmlPullParserException; {:try_start_3e .. :try_end_41} :catch_c2
    ...
    move-result v3
    :try_end_54
    .catchall {:try_start_42 .. :try_end_54} :catchall_b6
    ...
    invoke-interface {p2}, Landroid/content/res/XmlResourceParser;->close()V
    :try_end_5c
    .catch Lorg/xmlpull/v1/XmlPullParserException; {:try_start_59 .. :try_end_5c} :catch_c2
    .catch Ljava/io/IOException; {:try_start_59 .. :try_end_5c} :catch_c2
    ...
    throw p0
    :try_end_c2
    .catch Lorg/xmlpull/v1/XmlPullParserException; {:try_start_be .. :try_end_c2} :catch_c2
...
.method private parsePluginFromApplicationInfo(Landroid/content/pm/ResolveInfo;)Z
    ...
    iput v0, p0, Lcom/sonyericsson/android/camera/view/modeselector/CapturingModePluginsPMLoader$TmpUiAttributes;->mDescriptionLabelId:I
    :try_end_45
    .catch Landroid/content/pm/PackageManager$NameNotFoundException; {:try_start_0 .. :try_end_45} :catch_47
...
.method private parsePluginFromModeAttributesXmlFile(Landroid/content/pm/ActivityInfo;Landroid/content/res/Resources;)Z
    ...
    :try_end_1b
    .catch Lorg/xmlpull/v1/XmlPullParserException; {:try_start_18 .. :try_end_1b} :catch_2f
