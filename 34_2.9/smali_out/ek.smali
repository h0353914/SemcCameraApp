...
.method static a(Ler;Lfs;Ldv;Lfh;Lej;Lff;)Lek;
    ...
    if-eq v13, v5, :cond_217

    const/16 v5, 0x1b

    if-ne v13, v5, :cond_225
    ...
    if-eq v13, v5, :cond_222

    const/16 v5, 0xc

    if-eq v13, v5, :cond_25b
    ...
    if-eq v9, v15, :cond_35f

    const/16 v15, 0xc

    if-eq v9, v15, :cond_34c
...
.method private final b(Ljava/lang/Object;[BIILby;)V
    ...
    if-eq v0, v2, :cond_2be

    const/16 v2, 0x31

    if-gt v0, v2, :cond_26d
...
.method final a(Ljava/lang/Object;[BIIILby;)I
    ...
    packed-switch v8, :pswitch_data_534
    ...
    :try_end_4fe
    .catch Ljava/io/IOException; {:try_start_4f3 .. :try_end_4fe} :catch_509
    ...
    if-gt v1, v0, :cond_524

    if-ne v2, v10, :cond_524
